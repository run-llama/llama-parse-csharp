...
public sealed record class CodeItem : JsonModel
{
    ...
    /// </summary>
    public ApiEnum<string, global::LlamaCloud.Models.Parsing.Type>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, global::LlamaCloud.Models.Parsing.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::LlamaCloud.Models.Parsing.Type>
{
    public override global::LlamaCloud.Models.Parsing.Type Read(
    ...
    )
    {
        ...
        {
            "code" => global::LlamaCloud.Models.Parsing.Type.Code,
            _ => (global::LlamaCloud.Models.Parsing.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::LlamaCloud.Models.Parsing.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::LlamaCloud.Models.Parsing.Type.Code => "code",
