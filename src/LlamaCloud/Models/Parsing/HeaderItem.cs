...
[JsonConverter(typeof(JsonModelConverter<HeaderItem, HeaderItemFromRaw>))]
public sealed record class HeaderItem : JsonModel
{
    /// <summary>
    /// List of items within the header
    /// </summary>
    public required IReadOnlyList<HeaderItemItem> Items
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<HeaderItemItem>>("items");
        }
        init
        {
            this._rawData.Set<ImmutableArray<HeaderItemItem>>(
                "items",
    ...
    /// </summary>
    public ApiEnum<string, HeaderItemType>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ApiEnum<string, HeaderItemType>>("type");
        }
        init
        {
            if (value == null)
...
#pragma warning restore CS8618
    ...
    public HeaderItem(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    HeaderItem(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="HeaderItemFromRaw.FromRawUnchecked"/>
    public static HeaderItem FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class HeaderItemFromRaw : IFromRawJson<HeaderItem>
{
    /// <inheritdoc/>
    public HeaderItem FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        HeaderItem.FromRawUnchecked(rawData);
}

[JsonConverter(typeof(HeaderItemItemConverter))]
public record class HeaderItemItem : ModelBase
{
    ...
    public HeaderItemItem(CodeItem value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public HeaderItemItem(HeadingItem value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public HeaderItemItem(ImageItem value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public HeaderItemItem(LinkItem value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public HeaderItemItem(ListItem value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public HeaderItemItem(TableItem value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public HeaderItemItem(TextItem value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public HeaderItemItem(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of HeaderItemItem"
                );
        }
    }
    ...
    public static implicit operator HeaderItemItem(CodeItem value) => new(value);

    public static implicit operator HeaderItemItem(HeadingItem value) => new(value);

    public static implicit operator HeaderItemItem(ImageItem value) => new(value);

    public static implicit operator HeaderItemItem(LinkItem value) => new(value);

    public static implicit operator HeaderItemItem(ListItem value) => new(value);

    public static implicit operator HeaderItemItem(TableItem value) => new(value);

    public static implicit operator HeaderItemItem(TextItem value) => new(value);
    ...
    public virtual bool Equals(HeaderItemItem? other) =>
        other != null
...
sealed class HeaderItemItemConverter : JsonConverter<HeaderItemItem>
{
    public override HeaderItemItem? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new HeaderItemItem(element);
            }
        }
    }
...
/// Page header container
/// </summary>
[JsonConverter(typeof(HeaderItemTypeConverter))]
public enum HeaderItemType
{
    Header,
}

sealed class HeaderItemTypeConverter : JsonConverter<HeaderItemType>
{
    public override HeaderItemType Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
