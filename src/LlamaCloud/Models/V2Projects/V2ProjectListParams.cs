...
/// </summary>
public record class V2ProjectListParams : ParamsBase
{
    public string? Name
    {
        get
    ...
    public V2ProjectListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public V2ProjectListParams(V2ProjectListParams v2ProjectListParams)
        : base(v2ProjectListParams) { }
...
#pragma warning restore CS8618
    ...
    public static V2ProjectListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(V2ProjectListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v2/projects")
        {
