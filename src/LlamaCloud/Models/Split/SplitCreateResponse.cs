...
/// A split job.
/// </summary>
[JsonConverter(typeof(JsonModelConverter<SplitCreateResponse, SplitCreateResponseFromRaw>))]
public sealed record class SplitCreateResponse : JsonModel
{
    /// <summary>
    ...
    /// </summary>
    public SplitCreateResponseSplittingStrategy? SplittingStrategy
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<SplitCreateResponseSplittingStrategy>(
                "splitting_strategy"
            );
        }
        init
    ...
    public SplitCreateResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SplitCreateResponse(SplitCreateResponse splitCreateResponse)
        : base(splitCreateResponse) { }
#pragma warning restore CS8618

    public SplitCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SplitCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SplitCreateResponseFromRaw.FromRawUnchecked"/>
    public static SplitCreateResponse FromRawUnchecked(
...
class SplitCreateResponseFromRaw : IFromRawJson<SplitCreateResponse>
{
    /// <inheritdoc/>
    public SplitCreateResponse FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        SplitCreateResponse.FromRawUnchecked(rawData);
}
...
[JsonConverter(
    typeof(JsonModelConverter<
        SplitCreateResponseSplittingStrategy,
        SplitCreateResponseSplittingStrategyFromRaw
    >)
)]
public sealed record class SplitCreateResponseSplittingStrategy : JsonModel
{
    /// <summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SplitCreateResponseSplittingStrategy(
        SplitCreateResponseSplittingStrategy splitCreateResponseSplittingStrategy
    )
        : base(splitCreateResponseSplittingStrategy) { }
#pragma warning restore CS8618

    public SplitCreateResponseSplittingStrategy(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    SplitCreateResponseSplittingStrategy(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="SplitCreateResponseSplittingStrategyFromRaw.FromRawUnchecked"/>
    public static SplitCreateResponseSplittingStrategy FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class SplitCreateResponseSplittingStrategyFromRaw
    : IFromRawJson<SplitCreateResponseSplittingStrategy>
{
    /// <inheritdoc/>
    public SplitCreateResponseSplittingStrategy FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => SplitCreateResponseSplittingStrategy.FromRawUnchecked(rawData);
}
...
/// </summary>
[JsonConverter(typeof(SplitCreateResponseSplittingStrategyAllowUncategorizedConverter))]
public enum SplitCreateResponseSplittingStrategyAllowUncategorized
{
    Forbid,
    Include,
    Omit,
...
sealed class SplitCreateResponseSplittingStrategyAllowUncategorizedConverter
    : JsonConverter<SplitCreateResponseSplittingStrategyAllowUncategorized>
{
    public override SplitCreateResponseSplittingStrategyAllowUncategorized Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "forbid" => SplitCreateResponseSplittingStrategyAllowUncategorized.Forbid,
            "include" => SplitCreateResponseSplittingStrategyAllowUncategorized.Include,
            "omit" => SplitCreateResponseSplittingStrategyAllowUncategorized.Omit,
            _ => (SplitCreateResponseSplittingStrategyAllowUncategorized)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        SplitCreateResponseSplittingStrategyAllowUncategorized value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                SplitCreateResponseSplittingStrategyAllowUncategorized.Forbid => "forbid",
                SplitCreateResponseSplittingStrategyAllowUncategorized.Include => "include",
                SplitCreateResponseSplittingStrategyAllowUncategorized.Omit => "omit",
                _ => throw new LlamaCloudInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
