...
/// </summary>
public record class SplitDeleteParams : ParamsBase
{
    ...
    public SplitDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SplitDeleteParams(SplitDeleteParams splitDeleteParams)
        : base(splitDeleteParams)
    {
        this.SplitJobID = splitDeleteParams.SplitJobID;
    }
...
#pragma warning restore CS8618
    ...
    public static SplitDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string splitJobID
    )
    ...
    public virtual bool Equals(SplitDeleteParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/split/jobs/{0}", this.SplitJobID)
        )
        {
