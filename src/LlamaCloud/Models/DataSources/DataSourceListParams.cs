...
/// </summary>
public record class DataSourceListParams : ParamsBase
{
    ...
    public DataSourceListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DataSourceListParams(DataSourceListParams dataSourceListParams)
        : base(dataSourceListParams) { }
...
#pragma warning restore CS8618
    ...
    public static DataSourceListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(DataSourceListParams? other)
    {
        if (other == null)
        {
            return false;
