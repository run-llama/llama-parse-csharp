...
public record class DataSourceUpdateParams : ParamsBase
{
    ...
    public required ApiEnum<string, DataSourceUpdateParamsSourceType> SourceType
    {
        get
        {
    ...
    /// </summary>
    public DataSourceUpdateParamsComponent? Component
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<DataSourceUpdateParamsComponent>("component");
        }
    ...
    /// </summary>
    public IReadOnlyDictionary<string, DataSourceUpdateParamsCustomMetadata?>? CustomMetadata
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<
                FrozenDictionary<string, DataSourceUpdateParamsCustomMetadata?>
            >("custom_metadata");
        }
        init
        {
            this._rawBodyData.Set<FrozenDictionary<string, DataSourceUpdateParamsCustomMetadata?>?>(
                "custom_metadata",
...
[JsonConverter(typeof(DataSourceUpdateParamsSourceTypeConverter))]
public enum DataSourceUpdateParamsSourceType
{
    AzureStorageBlob,
    Box,
    Confluence,
...
sealed class DataSourceUpdateParamsSourceTypeConverter
    : JsonConverter<DataSourceUpdateParamsSourceType>
{
    public override DataSourceUpdateParamsSourceType Read(
    ...
    )
    {
        ...
        {
            "AZURE_STORAGE_BLOB" => DataSourceUpdateParamsSourceType.AzureStorageBlob,
            "BOX" => DataSourceUpdateParamsSourceType.Box,
            "CONFLUENCE" => DataSourceUpdateParamsSourceType.Confluence,
            "GOOGLE_DRIVE" => DataSourceUpdateParamsSourceType.GoogleDrive,
            "JIRA" => DataSourceUpdateParamsSourceType.Jira,
            "JIRA_V2" => DataSourceUpdateParamsSourceType.JiraV2,
            "MICROSOFT_ONEDRIVE" => DataSourceUpdateParamsSourceType.MicrosoftOnedrive,
            "MICROSOFT_SHAREPOINT" => DataSourceUpdateParamsSourceType.MicrosoftSharepoint,
            "NOTION_PAGE" => DataSourceUpdateParamsSourceType.NotionPage,
            "S3" => DataSourceUpdateParamsSourceType.S3,
            "SLACK" => DataSourceUpdateParamsSourceType.Slack,
            _ => (DataSourceUpdateParamsSourceType)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        DataSourceUpdateParamsSourceType value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                DataSourceUpdateParamsSourceType.AzureStorageBlob => "AZURE_STORAGE_BLOB",
                DataSourceUpdateParamsSourceType.Box => "BOX",
                DataSourceUpdateParamsSourceType.Confluence => "CONFLUENCE",
                DataSourceUpdateParamsSourceType.GoogleDrive => "GOOGLE_DRIVE",
                DataSourceUpdateParamsSourceType.Jira => "JIRA",
                DataSourceUpdateParamsSourceType.JiraV2 => "JIRA_V2",
                DataSourceUpdateParamsSourceType.MicrosoftOnedrive => "MICROSOFT_ONEDRIVE",
                DataSourceUpdateParamsSourceType.MicrosoftSharepoint => "MICROSOFT_SHAREPOINT",
                DataSourceUpdateParamsSourceType.NotionPage => "NOTION_PAGE",
                DataSourceUpdateParamsSourceType.S3 => "S3",
                DataSourceUpdateParamsSourceType.Slack => "SLACK",
...
/// Component that implements the data source
/// </summary>
[JsonConverter(typeof(DataSourceUpdateParamsComponentConverter))]
public record class DataSourceUpdateParamsComponent : ModelBase
{
    ...
    public DataSourceUpdateParamsComponent(
    ...
    public DataSourceUpdateParamsComponent(CloudS3DataSource value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    public DataSourceUpdateParamsComponent(CloudSlackDataSource value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    public DataSourceUpdateParamsComponent(CloudJiraDataSource value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public DataSourceUpdateParamsComponent(CloudJiraDataSourceV2 value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public DataSourceUpdateParamsComponent(CloudBoxDataSource value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public DataSourceUpdateParamsComponent(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of DataSourceUpdateParamsComponent"
                );
        }
    }
    ...
    public static implicit operator DataSourceUpdateParamsComponent(
        Dictionary<string, JsonElement> value
    ) => new((IReadOnlyDictionary<string, JsonElement>)value);

    public static implicit operator DataSourceUpdateParamsComponent(CloudS3DataSource value) =>
        new(value);
    ...
    public static implicit operator DataSourceUpdateParamsComponent(CloudSlackDataSource value) =>
        new(value);
    ...
    public static implicit operator DataSourceUpdateParamsComponent(CloudJiraDataSource value) =>
        new(value);

    public static implicit operator DataSourceUpdateParamsComponent(CloudJiraDataSourceV2 value) =>
        new(value);

    public static implicit operator DataSourceUpdateParamsComponent(CloudBoxDataSource value) =>
        new(value);
    ...
    public virtual bool Equals(DataSourceUpdateParamsComponent? other) =>
        other != null
...
sealed class DataSourceUpdateParamsComponentConverter
    : JsonConverter<DataSourceUpdateParamsComponent?>
{
    public override DataSourceUpdateParamsComponent? Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        DataSourceUpdateParamsComponent? value,
        JsonSerializerOptions options
    )
    {
...
[JsonConverter(typeof(DataSourceUpdateParamsCustomMetadataConverter))]
public record class DataSourceUpdateParamsCustomMetadata : ModelBase
{
    public object? Value { get; } = null;
    ...
    public DataSourceUpdateParamsCustomMetadata(
        IReadOnlyDictionary<string, JsonElement> value,
        JsonElement? element = null
    )
    {
    ...
    public DataSourceUpdateParamsCustomMetadata(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public DataSourceUpdateParamsCustomMetadata(double value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public DataSourceUpdateParamsCustomMetadata(bool value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public DataSourceUpdateParamsCustomMetadata(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of DataSourceUpdateParamsCustomMetadata"
                );
        }
    }
    ...
    public static implicit operator DataSourceUpdateParamsCustomMetadata(
        Dictionary<string, JsonElement> value
    ) => new((IReadOnlyDictionary<string, JsonElement>)value);

    public static implicit operator DataSourceUpdateParamsCustomMetadata(List<JsonElement> value) =>
        new((IReadOnlyList<JsonElement>)value);

    public static implicit operator DataSourceUpdateParamsCustomMetadata(string value) =>
        new(value);

    public static implicit operator DataSourceUpdateParamsCustomMetadata(double value) =>
        new(value);

    public static implicit operator DataSourceUpdateParamsCustomMetadata(bool value) => new(value);
    ...
    public virtual bool Equals(DataSourceUpdateParamsCustomMetadata? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class DataSourceUpdateParamsCustomMetadataConverter
    : JsonConverter<DataSourceUpdateParamsCustomMetadata?>
{
    public override DataSourceUpdateParamsCustomMetadata? Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        DataSourceUpdateParamsCustomMetadata? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
