...
/// </summary>
public record class DirectoryGetParams : ParamsBase
{
    ...
    public DirectoryGetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DirectoryGetParams(DirectoryGetParams directoryGetParams)
        : base(directoryGetParams)
    {
        this.DirectoryID = directoryGetParams.DirectoryID;
    }
...
#pragma warning restore CS8618
    ...
    public static DirectoryGetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string directoryID
    )
    ...
    public virtual bool Equals(DirectoryGetParams? other)
    {
        if (other == null)
        {
            return false;
