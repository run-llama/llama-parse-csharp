...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<FileAddResponse, FileAddResponseFromRaw>))]
public sealed record class FileAddResponse : JsonModel
{
    /// <summary>
    ...
    /// </summary>
    public IReadOnlyDictionary<string, FileAddResponseMetadata?>? Metadata
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                FrozenDictionary<string, FileAddResponseMetadata?>
            >("metadata");
        }
        init
        {
            ...
            this._rawData.Set<FrozenDictionary<string, FileAddResponseMetadata?>?>(
                "metadata",
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public FileAddResponse(FileAddResponse fileAddResponse)
        : base(fileAddResponse) { }
#pragma warning restore CS8618

    public FileAddResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    FileAddResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="FileAddResponseFromRaw.FromRawUnchecked"/>
    public static FileAddResponse FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }
}

class FileAddResponseFromRaw : IFromRawJson<FileAddResponse>
{
    /// <inheritdoc/>
    public FileAddResponse FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        FileAddResponse.FromRawUnchecked(rawData);
}

[JsonConverter(typeof(FileAddResponseMetadataConverter))]
public record class FileAddResponseMetadata : ModelBase
{
    ...
    public FileAddResponseMetadata(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileAddResponseMetadata(long value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileAddResponseMetadata(double value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileAddResponseMetadata(bool value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileAddResponseMetadata(IReadOnlyList<string> value, JsonElement? element = null)
    {
        this.Value = ImmutableArray.ToImmutableArray(value);
        this._element = element;
    }

    public FileAddResponseMetadata(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of FileAddResponseMetadata"
                );
        }
    }
    ...
    public static implicit operator FileAddResponseMetadata(string value) => new(value);

    public static implicit operator FileAddResponseMetadata(long value) => new(value);

    public static implicit operator FileAddResponseMetadata(double value) => new(value);

    public static implicit operator FileAddResponseMetadata(bool value) => new(value);

    public static implicit operator FileAddResponseMetadata(List<string> value) =>
    ...
    public virtual bool Equals(FileAddResponseMetadata? other) =>
        other != null
...
sealed class FileAddResponseMetadataConverter : JsonConverter<FileAddResponseMetadata>
{
    public override FileAddResponseMetadata? Read(
