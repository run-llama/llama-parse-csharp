...
public sealed record class FileUploadResponse : JsonModel
{
    ...
    /// </summary>
    public IReadOnlyDictionary<string, FileUploadResponseMetadata?>? Metadata
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                FrozenDictionary<string, FileUploadResponseMetadata?>
            >("metadata");
        }
        init
        {
            ...
            this._rawData.Set<FrozenDictionary<string, FileUploadResponseMetadata?>?>(
                "metadata",
...
[JsonConverter(typeof(FileUploadResponseMetadataConverter))]
public record class FileUploadResponseMetadata : ModelBase
{
    ...
    public FileUploadResponseMetadata(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUploadResponseMetadata(long value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUploadResponseMetadata(double value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUploadResponseMetadata(bool value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUploadResponseMetadata(IReadOnlyList<string> value, JsonElement? element = null)
    {
        this.Value = ImmutableArray.ToImmutableArray(value);
        this._element = element;
    }

    public FileUploadResponseMetadata(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of FileUploadResponseMetadata"
                );
        }
    }
    ...
    public static implicit operator FileUploadResponseMetadata(string value) => new(value);

    public static implicit operator FileUploadResponseMetadata(long value) => new(value);

    public static implicit operator FileUploadResponseMetadata(double value) => new(value);

    public static implicit operator FileUploadResponseMetadata(bool value) => new(value);

    public static implicit operator FileUploadResponseMetadata(List<string> value) =>
    ...
    public virtual bool Equals(FileUploadResponseMetadata? other) =>
        other != null
...
sealed class FileUploadResponseMetadataConverter : JsonConverter<FileUploadResponseMetadata>
{
    public override FileUploadResponseMetadata? Read(
    ...
    public override void Write(
        ...
        FileUploadResponseMetadata value,
        JsonSerializerOptions options
    )
    {
