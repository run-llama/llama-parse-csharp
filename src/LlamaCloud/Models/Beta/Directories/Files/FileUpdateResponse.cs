...
public sealed record class FileUpdateResponse : JsonModel
{
    ...
    /// </summary>
    public IReadOnlyDictionary<string, FileUpdateResponseMetadata?>? Metadata
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                FrozenDictionary<string, FileUpdateResponseMetadata?>
            >("metadata");
        }
        init
        {
            ...
            this._rawData.Set<FrozenDictionary<string, FileUpdateResponseMetadata?>?>(
                "metadata",
...
[JsonConverter(typeof(FileUpdateResponseMetadataConverter))]
public record class FileUpdateResponseMetadata : ModelBase
{
    ...
    public FileUpdateResponseMetadata(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUpdateResponseMetadata(long value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUpdateResponseMetadata(double value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUpdateResponseMetadata(bool value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUpdateResponseMetadata(IReadOnlyList<string> value, JsonElement? element = null)
    {
        this.Value = ImmutableArray.ToImmutableArray(value);
        this._element = element;
    }

    public FileUpdateResponseMetadata(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of FileUpdateResponseMetadata"
                );
        }
    }
    ...
    public static implicit operator FileUpdateResponseMetadata(string value) => new(value);

    public static implicit operator FileUpdateResponseMetadata(long value) => new(value);

    public static implicit operator FileUpdateResponseMetadata(double value) => new(value);

    public static implicit operator FileUpdateResponseMetadata(bool value) => new(value);

    public static implicit operator FileUpdateResponseMetadata(List<string> value) =>
    ...
    public virtual bool Equals(FileUpdateResponseMetadata? other) =>
        other != null
...
sealed class FileUpdateResponseMetadataConverter : JsonConverter<FileUpdateResponseMetadata>
{
    public override FileUpdateResponseMetadata? Read(
    ...
    public override void Write(
        ...
        FileUpdateResponseMetadata value,
        JsonSerializerOptions options
    )
    {
