...
public record class DirectoryCreateParams : ParamsBase
{
    ...
    /// </summary>
    public ApiEnum<string, global::LlamaCloud.Models.Beta.Directories.Type>? Type
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<
                ApiEnum<string, global::LlamaCloud.Models.Beta.Directories.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::LlamaCloud.Models.Beta.Directories.Type>
{
    public override global::LlamaCloud.Models.Beta.Directories.Type Read(
    ...
    )
    {
        ...
        {
            "ephemeral" => global::LlamaCloud.Models.Beta.Directories.Type.Ephemeral,
            "user" => global::LlamaCloud.Models.Beta.Directories.Type.User,
            _ => (global::LlamaCloud.Models.Beta.Directories.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::LlamaCloud.Models.Beta.Directories.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::LlamaCloud.Models.Beta.Directories.Type.Ephemeral => "ephemeral",
                global::LlamaCloud.Models.Beta.Directories.Type.User => "user",
