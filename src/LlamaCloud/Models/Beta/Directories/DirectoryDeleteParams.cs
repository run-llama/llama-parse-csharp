...
/// </summary>
public record class DirectoryDeleteParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DirectoryDeleteParams(DirectoryDeleteParams directoryDeleteParams)
        : base(directoryDeleteParams)
    {
        this.DirectoryID = directoryDeleteParams.DirectoryID;
    }
...
#pragma warning restore CS8618
    ...
    public static DirectoryDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string directoryID
    )
    ...
    public virtual bool Equals(DirectoryDeleteParams? other)
    {
        if (other == null)
        {
            return false;
