...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<IndexCreateResponse, IndexCreateResponseFromRaw>))]
public sealed record class IndexCreateResponse : JsonModel
{
    /// <summary>
    /// Unique identifier
    /// </summary>
    ...
    public IndexCreateResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IndexCreateResponse(IndexCreateResponse indexCreateResponse)
        : base(indexCreateResponse) { }
#pragma warning restore CS8618

    public IndexCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    IndexCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="IndexCreateResponseFromRaw.FromRawUnchecked"/>
    public static IndexCreateResponse FromRawUnchecked(
...
class IndexCreateResponseFromRaw : IFromRawJson<IndexCreateResponse>
{
    /// <inheritdoc/>
    public IndexCreateResponse FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        IndexCreateResponse.FromRawUnchecked(rawData);
}
