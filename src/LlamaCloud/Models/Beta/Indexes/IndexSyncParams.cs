...
/// </summary>
public record class IndexSyncParams : ParamsBase
{
    ...
    public IndexSyncParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IndexSyncParams(IndexSyncParams indexSyncParams)
        : base(indexSyncParams)
    {
        this.IndexID = indexSyncParams.IndexID;
    }
...
#pragma warning restore CS8618
    ...
    public static IndexSyncParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string indexID
    )
    ...
    public virtual bool Equals(IndexSyncParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/indexes/{0}/sync", this.IndexID)
        )
        {
