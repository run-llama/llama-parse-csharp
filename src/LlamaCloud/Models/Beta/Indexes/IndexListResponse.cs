...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<IndexListResponse, IndexListResponseFromRaw>))]
public sealed record class IndexListResponse : JsonModel
{
    /// <summary>
    /// Unique identifier
    /// </summary>
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IndexListResponse(IndexListResponse indexListResponse)
        : base(indexListResponse) { }
#pragma warning restore CS8618

    public IndexListResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    IndexListResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="IndexListResponseFromRaw.FromRawUnchecked"/>
    public static IndexListResponse FromRawUnchecked(
...
class IndexListResponseFromRaw : IFromRawJson<IndexListResponse>
{
    /// <inheritdoc/>
    public IndexListResponse FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        IndexListResponse.FromRawUnchecked(rawData);
}
