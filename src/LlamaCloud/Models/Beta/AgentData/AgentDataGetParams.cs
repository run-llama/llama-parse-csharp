...
/// </summary>
public record class AgentDataGetParams : ParamsBase
{
    ...
    public AgentDataGetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AgentDataGetParams(AgentDataGetParams agentDataGetParams)
        : base(agentDataGetParams)
    {
        this.ItemID = agentDataGetParams.ItemID;
    }
...
#pragma warning restore CS8618
    ...
    public static AgentDataGetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string itemID
    )
    ...
    public virtual bool Equals(AgentDataGetParams? other)
    {
        if (other == null)
        {
            return false;
