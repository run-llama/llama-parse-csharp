...
/// </summary>
public record class RetrievalReadParams : ParamsBase
{
    ...
    public long? MaxLength
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableStruct<long>("max_length");
        }
        init { this._rawBodyData.Set("max_length", value); }
    }
    ...
    public RetrievalReadParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RetrievalReadParams(RetrievalReadParams retrievalReadParams)
        : base(retrievalReadParams)
    {
        this._rawBodyData = new(retrievalReadParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static RetrievalReadParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(RetrievalReadParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/retrieval/files/read"
        )
        {
