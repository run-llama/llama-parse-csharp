...
/// </summary>
public record class AttachmentListParams : ParamsBase
{
    /// <summary>
    ...
    public AttachmentListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AttachmentListParams(AttachmentListParams attachmentListParams)
        : base(attachmentListParams) { }
...
#pragma warning restore CS8618
    ...
    public static AttachmentListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(AttachmentListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/beta/attachments")
        {
