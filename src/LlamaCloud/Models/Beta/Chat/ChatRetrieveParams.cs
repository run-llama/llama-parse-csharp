...
public record class ChatRetrieveParams : ParamsBase
{
    ...
    public ChatRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ChatRetrieveParams(ChatRetrieveParams chatRetrieveParams)
        : base(chatRetrieveParams)
    {
        this.SessionID = chatRetrieveParams.SessionID;
    }
...
#pragma warning restore CS8618
    ...
    public static ChatRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string sessionID
    )
    ...
    public virtual bool Equals(ChatRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
