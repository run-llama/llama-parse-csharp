...
/// </summary>
public record class DataSinkCreateParams : ParamsBase
{
    ...
    public required ApiEnum<string, SinkType> SinkType
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<ApiEnum<string, SinkType>>("sink_type");
        }
    ...
    public DataSinkCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DataSinkCreateParams(DataSinkCreateParams dataSinkCreateParams)
        : base(dataSinkCreateParams)
    {
        this._rawBodyData = new(dataSinkCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static DataSinkCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(DataSinkCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/data-sinks")
        {
