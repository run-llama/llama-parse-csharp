...
/// </summary>
public record class DataSinkListPaginatedParams : ParamsBase
{
    /// <summary>
    ...
    public DataSinkListPaginatedParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DataSinkListPaginatedParams(DataSinkListPaginatedParams dataSinkListPaginatedParams)
        : base(dataSinkListPaginatedParams) { }
...
#pragma warning restore CS8618
    ...
    public static DataSinkListPaginatedParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(DataSinkListPaginatedParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/beta/data-sinks")
        {
