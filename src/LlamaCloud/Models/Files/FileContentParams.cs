...
/// </summary>
public record class FileContentParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public FileContentParams(FileContentParams fileContentParams)
        : base(fileContentParams)
    {
...
#pragma warning restore CS8618
    ...
    public static FileContentParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string fileID
    )
    ...
    public virtual bool Equals(FileContentParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/beta/files/{0}/content", this.FileID)
        )
        {
