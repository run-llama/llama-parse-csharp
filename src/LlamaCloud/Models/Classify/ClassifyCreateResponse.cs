...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<ClassifyCreateResponse, ClassifyCreateResponseFromRaw>))]
public sealed record class ClassifyCreateResponse : JsonModel
{
    /// <summary>
    /// Unique identifier
    /// </summary>
    ...
    /// </summary>
    public required ApiEnum<string, ClassifyCreateResponseStatus> Status
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<ApiEnum<string, ClassifyCreateResponseStatus>>(
                "status"
            );
        }
    ...
    public ClassifyCreateResponse() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ClassifyCreateResponse(ClassifyCreateResponse classifyCreateResponse)
        : base(classifyCreateResponse) { }
#pragma warning restore CS8618

    public ClassifyCreateResponse(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ClassifyCreateResponse(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ClassifyCreateResponseFromRaw.FromRawUnchecked"/>
    public static ClassifyCreateResponse FromRawUnchecked(
...
class ClassifyCreateResponseFromRaw : IFromRawJson<ClassifyCreateResponse>
{
    /// <inheritdoc/>
    public ClassifyCreateResponse FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ClassifyCreateResponse.FromRawUnchecked(rawData);
}
...
/// Current job status: PENDING, RUNNING, COMPLETED, FAILED, or CANCELLED
/// </summary>
[JsonConverter(typeof(ClassifyCreateResponseStatusConverter))]
public enum ClassifyCreateResponseStatus
{
    Cancelled,
    Completed,
    Failed,
...
sealed class ClassifyCreateResponseStatusConverter : JsonConverter<ClassifyCreateResponseStatus>
{
    public override ClassifyCreateResponseStatus Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "CANCELLED" => ClassifyCreateResponseStatus.Cancelled,
            "COMPLETED" => ClassifyCreateResponseStatus.Completed,
            "FAILED" => ClassifyCreateResponseStatus.Failed,
            "PENDING" => ClassifyCreateResponseStatus.Pending,
            "RUNNING" => ClassifyCreateResponseStatus.Running,
            _ => (ClassifyCreateResponseStatus)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        ClassifyCreateResponseStatus value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ClassifyCreateResponseStatus.Cancelled => "CANCELLED",
                ClassifyCreateResponseStatus.Completed => "COMPLETED",
                ClassifyCreateResponseStatus.Failed => "FAILED",
                ClassifyCreateResponseStatus.Pending => "PENDING",
                ClassifyCreateResponseStatus.Running => "RUNNING",
                _ => throw new LlamaCloudInvalidDataException(
                    string.Format("Invalid value '{0}' in {1}", value, nameof(value))
                ),
            },
