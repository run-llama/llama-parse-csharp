...
/// </summary>
public record class ClassifyDeleteParams : ParamsBase
{
    ...
    public ClassifyDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ClassifyDeleteParams(ClassifyDeleteParams classifyDeleteParams)
        : base(classifyDeleteParams)
    {
        this.JobID = classifyDeleteParams.JobID;
    }
...
#pragma warning restore CS8618
    ...
    public static ClassifyDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string jobID
    )
    ...
    public virtual bool Equals(ClassifyDeleteParams? other)
    {
        if (other == null)
        {
            return false;
