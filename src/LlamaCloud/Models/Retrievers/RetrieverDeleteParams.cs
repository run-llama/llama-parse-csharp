...
/// </summary>
public record class RetrieverDeleteParams : ParamsBase
{
    ...
    public RetrieverDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RetrieverDeleteParams(RetrieverDeleteParams retrieverDeleteParams)
        : base(retrieverDeleteParams)
    {
        this.RetrieverID = retrieverDeleteParams.RetrieverID;
    }
...
#pragma warning restore CS8618
    ...
    public static RetrieverDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string retrieverID
    )
    ...
    public virtual bool Equals(RetrieverDeleteParams? other)
    {
        if (other == null)
        {
            return false;
