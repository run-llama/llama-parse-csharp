...
/// </summary>
public record class WebhookConfigRetrieveParams : ParamsBase
{
    ...
    public WebhookConfigRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WebhookConfigRetrieveParams(WebhookConfigRetrieveParams webhookConfigRetrieveParams)
        : base(webhookConfigRetrieveParams)
    {
        this.ConfigID = webhookConfigRetrieveParams.ConfigID;
    }
...
#pragma warning restore CS8618
    ...
    public static WebhookConfigRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string configID
    )
    ...
    public virtual bool Equals(WebhookConfigRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
