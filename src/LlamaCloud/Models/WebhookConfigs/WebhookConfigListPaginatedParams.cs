...
/// </summary>
public record class WebhookConfigListPaginatedParams : ParamsBase
{
    /// <summary>
    ...
    public WebhookConfigListPaginatedParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WebhookConfigListPaginatedParams(
        WebhookConfigListPaginatedParams webhookConfigListPaginatedParams
    )
        : base(webhookConfigListPaginatedParams) { }
...
#pragma warning restore CS8618
    ...
    public static WebhookConfigListPaginatedParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(WebhookConfigListPaginatedParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v2/webhook-configs")
        {
