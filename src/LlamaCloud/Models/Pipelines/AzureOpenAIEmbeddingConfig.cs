...
public sealed record class AzureOpenAIEmbeddingConfig : JsonModel
{
    ...
    /// </summary>
    public ApiEnum<string, global::LlamaCloud.Models.Pipelines.Type>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, global::LlamaCloud.Models.Pipelines.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::LlamaCloud.Models.Pipelines.Type>
{
    public override global::LlamaCloud.Models.Pipelines.Type Read(
    ...
    )
    {
        ...
        {
            "AZURE_EMBEDDING" => global::LlamaCloud.Models.Pipelines.Type.AzureEmbedding,
            _ => (global::LlamaCloud.Models.Pipelines.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::LlamaCloud.Models.Pipelines.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::LlamaCloud.Models.Pipelines.Type.AzureEmbedding => "AZURE_EMBEDDING",
