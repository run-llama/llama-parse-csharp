...
namespace LlamaCloud.Models.Pipelines.Metadata;
...
/// </summary>
[Obsolete("deprecated")]
public record class MetadataCreateParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public MetadataCreateParams(MetadataCreateParams metadataCreateParams)
        : base(metadataCreateParams)
    {
        this.PipelineID = metadataCreateParams.PipelineID;

        this._rawBodyData = new(metadataCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static MetadataCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, MultipartJsonElement> rawBodyData,
        string pipelineID
    ...
    public virtual bool Equals(MetadataCreateParams? other)
    {
        if (other == null)
        {
            return false;
