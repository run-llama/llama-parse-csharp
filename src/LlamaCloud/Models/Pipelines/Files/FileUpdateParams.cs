...
public record class FileUpdateParams : ParamsBase
{
    ...
    /// </summary>
    public IReadOnlyDictionary<string, FileUpdateParamsCustomMetadata?>? CustomMetadata
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<
                FrozenDictionary<string, FileUpdateParamsCustomMetadata?>
            >("custom_metadata");
        }
        init
        {
            this._rawBodyData.Set<FrozenDictionary<string, FileUpdateParamsCustomMetadata?>?>(
                "custom_metadata",
...
#pragma warning disable CS8618
    ...
    {
        this.PipelineID = fileUpdateParams.PipelineID;
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v1/pipelines/{0}/files/{1}", this.PipelineID, this.FileID)
        )
        {
...
[JsonConverter(typeof(FileUpdateParamsCustomMetadataConverter))]
public record class FileUpdateParamsCustomMetadata : ModelBase
{
    ...
    public FileUpdateParamsCustomMetadata(
    ...
    public FileUpdateParamsCustomMetadata(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUpdateParamsCustomMetadata(double value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUpdateParamsCustomMetadata(bool value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileUpdateParamsCustomMetadata(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of FileUpdateParamsCustomMetadata"
                );
        }
    }
    ...
    public static implicit operator FileUpdateParamsCustomMetadata(
        Dictionary<string, JsonElement> value
    ) => new((IReadOnlyDictionary<string, JsonElement>)value);

    public static implicit operator FileUpdateParamsCustomMetadata(List<JsonElement> value) =>
        new((IReadOnlyList<JsonElement>)value);

    public static implicit operator FileUpdateParamsCustomMetadata(string value) => new(value);

    public static implicit operator FileUpdateParamsCustomMetadata(double value) => new(value);

    public static implicit operator FileUpdateParamsCustomMetadata(bool value) => new(value);
    ...
    public virtual bool Equals(FileUpdateParamsCustomMetadata? other) =>
        other != null
...
sealed class FileUpdateParamsCustomMetadataConverter
    : JsonConverter<FileUpdateParamsCustomMetadata?>
{
    public override FileUpdateParamsCustomMetadata? Read(
    ...
    public override void Write(
        ...
        FileUpdateParamsCustomMetadata? value,
        JsonSerializerOptions options
    )
    {
