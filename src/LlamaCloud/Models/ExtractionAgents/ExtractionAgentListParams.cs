...
/// </summary>
public record class ExtractionAgentListParams : ParamsBase
{
    /// <summary>
    ...
    public ExtractionAgentListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExtractionAgentListParams(ExtractionAgentListParams extractionAgentListParams)
        : base(extractionAgentListParams) { }
...
#pragma warning restore CS8618
    ...
    public static ExtractionAgentListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ExtractionAgentListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/beta/extraction-agents"
        )
        {
