...
public record class ExtractDeleteParams : ParamsBase
{
    ...
    public ExtractDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExtractDeleteParams(ExtractDeleteParams extractDeleteParams)
        : base(extractDeleteParams)
    {
        this.JobID = extractDeleteParams.JobID;
    }
...
#pragma warning restore CS8618
    ...
    public static ExtractDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string jobID
    )
    ...
    public virtual bool Equals(ExtractDeleteParams? other)
    {
        if (other == null)
        {
            return false;
