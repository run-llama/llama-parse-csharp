...
public record class ExtractResult : ModelBase
{
    ...
    public ExtractResult(
        IReadOnlyList<IReadOnlyDictionary<string, UnnamedSchemaWithArrayParent1Item?>> value,
        JsonElement? element = null
    )
    {
    ...
    /// <summary>
    /// Returns true and sets the <c>out</c> parameter if the instance was constructed with a variant of
    /// type <see cref="List{T}"/> where <c>T</c> is a <c>Dictionary&lt;string, UnnamedSchemaWithArrayParent1Item?&gt;</c>.
    ///
    /// <para>Consider using <see cref="Switch"/> or <see cref="Match"/> if you need to handle every variant.</para>
    ///
    /// <example>
    /// <code>
    /// if (instance.TryPickUnnamedSchemaWithArrayParent1Items(out var value)) {
    ///     // `value` is of type `IReadOnlyList&lt;IReadOnlyDictionary&lt;string, UnnamedSchemaWithArrayParent1Item?&gt;&gt;`
    ///     Console.WriteLine(value);
    /// }
    /// </code>
    /// </example>
    /// </summary>
    public bool TryPickUnnamedSchemaWithArrayParent1Items(
        [NotNullWhen(true)]
            out IReadOnlyList<
            IReadOnlyDictionary<string, UnnamedSchemaWithArrayParent1Item?>
        >? value
    )
    {
        value =
            this.Value
            as IReadOnlyList<IReadOnlyDictionary<string, UnnamedSchemaWithArrayParent1Item?>>;
        return value != null;
    }
    ...
    public void Switch(
        ...
        > unnamedSchemaWithArrayParent1Items
    )
    {
        switch (this.Value)
        {
            ...
            case IReadOnlyList<
                IReadOnlyDictionary<string, UnnamedSchemaWithArrayParent1Item?>
            > value:
                unnamedSchemaWithArrayParent1Items(value);
                break;
            default:
    ...
    public static implicit operator ExtractResult(
        List<Dictionary<string, UnnamedSchemaWithArrayParent1Item?>> value
    ) => new((IReadOnlyList<IReadOnlyDictionary<string, UnnamedSchemaWithArrayParent1Item?>>)value);
    ...
    public override void Validate()
    {
        ...
        this.Switch(
            ...
            (unnamedSchemaWithArrayParent1Items) =>
            {
                foreach (var item in unnamedSchemaWithArrayParent1Items)
                {
    ...
    int VariantIndex()
    {
        return this.Value switch
        {
            ...
            IReadOnlyList<IReadOnlyDictionary<string, UnnamedSchemaWithArrayParent1Item?>> _ => 1,
            _ => -1,
        };
    }
}
    ...
    )
    {
        ...
        try
        {
            var deserialized = JsonSerializer.Deserialize<
                List<Dictionary<string, UnnamedSchemaWithArrayParent1Item?>>
            >(element, options);
            if (deserialized != null)
            {
...
[JsonConverter(typeof(UnnamedSchemaWithArrayParent1ItemConverter))]
public record class UnnamedSchemaWithArrayParent1Item : ModelBase
{
    public object? Value { get; } = null;
    ...
    public UnnamedSchemaWithArrayParent1Item(
        IReadOnlyDictionary<string, JsonElement> value,
        JsonElement? element = null
    )
    {
    ...
    public UnnamedSchemaWithArrayParent1Item(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public UnnamedSchemaWithArrayParent1Item(double value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public UnnamedSchemaWithArrayParent1Item(bool value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public UnnamedSchemaWithArrayParent1Item(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of UnnamedSchemaWithArrayParent1Item"
                );
        }
    }
    ...
    public static implicit operator UnnamedSchemaWithArrayParent1Item(
        Dictionary<string, JsonElement> value
    ) => new((IReadOnlyDictionary<string, JsonElement>)value);

    public static implicit operator UnnamedSchemaWithArrayParent1Item(List<JsonElement> value) =>
        new((IReadOnlyList<JsonElement>)value);

    public static implicit operator UnnamedSchemaWithArrayParent1Item(string value) => new(value);

    public static implicit operator UnnamedSchemaWithArrayParent1Item(double value) => new(value);

    public static implicit operator UnnamedSchemaWithArrayParent1Item(bool value) => new(value);
    ...
    public virtual bool Equals(UnnamedSchemaWithArrayParent1Item? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class UnnamedSchemaWithArrayParent1ItemConverter
    : JsonConverter<UnnamedSchemaWithArrayParent1Item?>
{
    public override UnnamedSchemaWithArrayParent1Item? Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        UnnamedSchemaWithArrayParent1Item? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
