...
using Beta = LlamaCloud.Services.Beta;
...
public interface IBetaService
{
    ...
    Beta::IIndexService Indexes { get; }

    Beta::IRetrievalService Retrieval { get; }
...
public interface IBetaServiceWithRawResponse
{
    ...
    Beta::IIndexServiceWithRawResponse Indexes { get; }
    ...
    Beta::ISplitServiceWithRawResponse Split { get; }
}
