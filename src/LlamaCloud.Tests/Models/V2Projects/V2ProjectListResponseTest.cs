...
public class V2ProjectListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new V2ProjectListResponse
        {
            ID = "id",
            Name = "name",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<V2ProjectListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        V2ProjectListResponse copied = new(model);
