...
public class RetrieverListPaginatedParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new RetrieverListPaginatedParams
        {
            IncludeTotal = true,
            Name = "name",
    ...
    {
        var parameters = new RetrieverListPaginatedParams { IncludeTotal = true, PageSize = 1 };
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.cloud.llamaindex.ai/api/v1/beta/retrievers?include_total=true&name=name&organization_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&page_size=1&page_token=page_token&project_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        RetrieverListPaginatedParams copied = new(parameters);
