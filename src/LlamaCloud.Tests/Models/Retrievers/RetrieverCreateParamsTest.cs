...
public class RetrieverCreateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new RetrieverCreateParams
        {
            Name = "x",
    ...
    {
        RetrieverCreateParams parameters = new()
        {
            Name = "x",
            OrganizationID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ProjectID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    public void CopyConstructor_Works()
    {
        ...
        RetrieverCreateParams copied = new(parameters);
