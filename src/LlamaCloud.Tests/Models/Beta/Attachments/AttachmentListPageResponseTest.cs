...
public class AttachmentListPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AttachmentListPageResponse
        {
            Items =
            [
                new()
        ...
        List<AttachmentListResponse> expectedItems =
        [
            new()
            {
                Name = "name",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AttachmentListPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AttachmentListPageResponse copied = new(model);
