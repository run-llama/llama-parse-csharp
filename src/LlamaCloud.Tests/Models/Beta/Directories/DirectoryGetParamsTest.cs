...
public class DirectoryGetParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new DirectoryGetParams
        {
    ...
    {
        var parameters = new DirectoryGetParams { DirectoryID = "directory_id" };
    ...
    {
        DirectoryGetParams parameters = new()
        {
            DirectoryID = "directory_id",
            OrganizationID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ProjectID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    public void CopyConstructor_Works()
    {
        ...
        DirectoryGetParams copied = new(parameters);
