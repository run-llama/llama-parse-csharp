...
public class DirectoryCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DirectoryCreateResponse
        {
            ID = "id",
            Name = "x",
            ...
            Type = DirectoryCreateResponseType.Ephemeral,
        ...
        ApiEnum<string, DirectoryCreateResponseType> expectedType =
            DirectoryCreateResponseType.Ephemeral;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<DirectoryCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        DirectoryCreateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class DirectoryCreateResponseTypeTest : TestBase
{
    [Theory]
    [InlineData(DirectoryCreateResponseType.Ephemeral)]
    [InlineData(DirectoryCreateResponseType.Index)]
    [InlineData(DirectoryCreateResponseType.User)]
    public void Validation_Works(DirectoryCreateResponseType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DirectoryCreateResponseType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, DirectoryCreateResponseType>>(
    ...
    [InlineData(DirectoryCreateResponseType.Index)]
    [InlineData(DirectoryCreateResponseType.User)]
    public void SerializationRoundtrip_Works(DirectoryCreateResponseType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DirectoryCreateResponseType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, DirectoryCreateResponseType>>(
            json,
            ModelBase.SerializerOptions
        );
