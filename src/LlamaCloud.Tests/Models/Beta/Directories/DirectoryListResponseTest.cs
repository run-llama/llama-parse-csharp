...
public class DirectoryListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DirectoryListResponse
        {
            ID = "id",
            Name = "x",
            ...
            Type = DirectoryListResponseType.Ephemeral,
        ...
        ApiEnum<string, DirectoryListResponseType> expectedType =
            DirectoryListResponseType.Ephemeral;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<DirectoryListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        DirectoryListResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class DirectoryListResponseTypeTest : TestBase
{
    [Theory]
    [InlineData(DirectoryListResponseType.Ephemeral)]
    [InlineData(DirectoryListResponseType.Index)]
    [InlineData(DirectoryListResponseType.User)]
    public void Validation_Works(DirectoryListResponseType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DirectoryListResponseType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, DirectoryListResponseType>>(
    ...
    [InlineData(DirectoryListResponseType.Index)]
    [InlineData(DirectoryListResponseType.User)]
    public void SerializationRoundtrip_Works(DirectoryListResponseType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DirectoryListResponseType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, DirectoryListResponseType>>(
            json,
            ModelBase.SerializerOptions
        );
