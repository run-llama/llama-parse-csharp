...
public class FileGetResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FileGetResponse
        {
            ID = "id",
            ...
            FileID = "file_id",
            Metadata = new Dictionary<string, FileGetResponseMetadata?>() { { "foo", "string" } },
        ...
        Dictionary<string, FileGetResponseMetadata?> expectedMetadata = new()
        {
            { "foo", "string" },
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FileGetResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        FileGetResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FileGetResponseMetadataTest : TestBase
{
    [Fact]
    public void StringValidationWorks()
    {
        FileGetResponseMetadata value = "string";
        value.Validate();
    }
    ...
    {
        FileGetResponseMetadata value = 0;
        value.Validate();
    }
    ...
    {
        FileGetResponseMetadata value = true;
        value.Validate();
    }
    ...
    {
        FileGetResponseMetadata value = new(["string"]);
        value.Validate();
    }
    ...
    public void StringSerializationRoundtripWorks()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FileGetResponseMetadata>(
            element,
            ModelBase.SerializerOptions
        );
