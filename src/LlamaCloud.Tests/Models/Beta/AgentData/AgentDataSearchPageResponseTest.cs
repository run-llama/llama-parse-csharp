...
public class AgentDataSearchPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AgentDataSearchPageResponse
        {
            Items =
            [
                new()
        ...
        List<AgentDataAgentData> expectedItems =
        [
            new()
            {
                Data = new Dictionary<string, JsonElement>()
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AgentDataSearchPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AgentDataSearchPageResponse copied = new(model);
