...
public class IndexListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new IndexListResponse
        {
            ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<IndexListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        IndexListResponse copied = new(model);
