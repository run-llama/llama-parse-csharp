...
public class ExtractListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ExtractListParams
        {
        ...
        string expectedDocumentInputType = "document_input_type";
        string expectedDocumentInputValue = "document_input_value";
        ...
        Assert.Equal(expectedDocumentInputType, parameters.DocumentInputType);
        Assert.Equal(expectedDocumentInputValue, parameters.DocumentInputValue);
    ...
    {
        var parameters = new ExtractListParams { Expand = ["string"] };
        ...
        Assert.Null(parameters.DocumentInputType);
        Assert.False(parameters.RawQueryData.ContainsKey("document_input_type"));
        Assert.Null(parameters.DocumentInputValue);
        Assert.False(parameters.RawQueryData.ContainsKey("document_input_value"));
        Assert.Null(parameters.FileInput);
        Assert.False(parameters.RawQueryData.ContainsKey("file_input"));
    ...
    public void OptionalNullableParamsSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(parameters.DocumentInputType);
        Assert.True(parameters.RawQueryData.ContainsKey("document_input_type"));
        Assert.Null(parameters.DocumentInputValue);
        Assert.True(parameters.RawQueryData.ContainsKey("document_input_value"));
        Assert.Null(parameters.FileInput);
        Assert.True(parameters.RawQueryData.ContainsKey("file_input"));
        Assert.Null(parameters.JobIds);
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.cloud.llamaindex.ai/api/v2/extract?configuration_id=cfg-11111111-2222-3333-4444-555555555555&created_at_on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at_on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&document_input_type=document_input_type&document_input_value=document_input_value&expand=string&file_input=file_input&job_ids=string&job_ids=string&organization_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&page_size=0&page_token=page_token&project_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&status=CANCELLED"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ExtractListParams copied = new(parameters);
