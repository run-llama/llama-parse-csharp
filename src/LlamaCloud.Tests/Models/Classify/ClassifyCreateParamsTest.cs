...
public class ClassifyCreateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ClassifyCreateParams
        {
        ...
        Assert.Equal(expectedParseJobID, parameters.ParseJobID);
    ...
    public void OptionalNullableParamsUnsetAreNotSet_Works()
    {
        ...
        Assert.Null(parameters.ParseJobID);
        Assert.False(parameters.RawBodyData.ContainsKey("parse_job_id"));
    ...
    public void OptionalNullableParamsSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(parameters.ParseJobID);
        Assert.True(parameters.RawBodyData.ContainsKey("parse_job_id"));
        Assert.Null(parameters.TransactionID);
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.cloud.llamaindex.ai/api/v2/classify?organization_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&project_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ClassifyCreateParams copied = new(parameters);
