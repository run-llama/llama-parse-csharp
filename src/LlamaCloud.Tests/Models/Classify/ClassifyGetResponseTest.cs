...
public class ClassifyGetResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ClassifyGetResponse
        {
            ID = "id",
            Configuration = new()
            {
        ...
        ApiEnum<string, ClassifyGetResponseDocumentInputType> expectedDocumentInputType =
            ClassifyGetResponseDocumentInputType.FileID;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ClassifyGetResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ClassifyGetResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ClassifyGetResponseDocumentInputTypeTest : TestBase
{
    [Theory]
    [InlineData(ClassifyGetResponseDocumentInputType.FileID)]
    [InlineData(ClassifyGetResponseDocumentInputType.ParseJobID)]
    [InlineData(ClassifyGetResponseDocumentInputType.Url)]
    public void Validation_Works(ClassifyGetResponseDocumentInputType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyGetResponseDocumentInputType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ClassifyGetResponseDocumentInputType.ParseJobID)]
    [InlineData(ClassifyGetResponseDocumentInputType.Url)]
    public void SerializationRoundtrip_Works(ClassifyGetResponseDocumentInputType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyGetResponseDocumentInputType> value = rawValue;
...
public class ClassifyGetResponseStatusTest : TestBase
{
    ...
    [InlineData(ClassifyGetResponseStatus.Running)]
    public void Validation_Works(ClassifyGetResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyGetResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, ClassifyGetResponseStatus>>(
    ...
    [InlineData(ClassifyGetResponseStatus.Pending)]
    [InlineData(ClassifyGetResponseStatus.Running)]
    public void SerializationRoundtrip_Works(ClassifyGetResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyGetResponseStatus> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, ClassifyGetResponseStatus>>(
            json,
            ModelBase.SerializerOptions
        );
