...
public class ClassifyListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ClassifyListResponse
        {
            ID = "id",
            Configuration = new()
            {
        ...
        ApiEnum<string, ClassifyListResponseDocumentInputType> expectedDocumentInputType =
            ClassifyListResponseDocumentInputType.FileID;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ClassifyListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ClassifyListResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ClassifyListResponseDocumentInputTypeTest : TestBase
{
    [Theory]
    [InlineData(ClassifyListResponseDocumentInputType.FileID)]
    [InlineData(ClassifyListResponseDocumentInputType.ParseJobID)]
    [InlineData(ClassifyListResponseDocumentInputType.Url)]
    public void Validation_Works(ClassifyListResponseDocumentInputType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyListResponseDocumentInputType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ClassifyListResponseDocumentInputType.ParseJobID)]
    [InlineData(ClassifyListResponseDocumentInputType.Url)]
    public void SerializationRoundtrip_Works(ClassifyListResponseDocumentInputType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyListResponseDocumentInputType> value = rawValue;
...
public class ClassifyListResponseStatusTest : TestBase
{
    ...
    [InlineData(ClassifyListResponseStatus.Running)]
    public void Validation_Works(ClassifyListResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyListResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, ClassifyListResponseStatus>>(
    ...
    [InlineData(ClassifyListResponseStatus.Pending)]
    [InlineData(ClassifyListResponseStatus.Running)]
    public void SerializationRoundtrip_Works(ClassifyListResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyListResponseStatus> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, ClassifyListResponseStatus>>(
            json,
            ModelBase.SerializerOptions
        );
