...
public class ClassifyCancelResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ClassifyCancelResponse
        {
            ID = "id",
            Configuration = new()
            {
            ...
            DocumentInputType = ClassifyCancelResponseDocumentInputType.FileID,
            FileInput = "file_input",
            ProjectID = "project_id",
            Status = ClassifyCancelResponseStatus.Cancelled,
            UserID = "user_id",
        ...
        ApiEnum<string, ClassifyCancelResponseDocumentInputType> expectedDocumentInputType =
            ClassifyCancelResponseDocumentInputType.FileID;
        string expectedFileInput = "file_input";
        string expectedProjectID = "project_id";
        ApiEnum<string, ClassifyCancelResponseStatus> expectedStatus =
            ClassifyCancelResponseStatus.Cancelled;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ClassifyCancelResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ClassifyCancelResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ClassifyCancelResponseDocumentInputTypeTest : TestBase
{
    [Theory]
    [InlineData(ClassifyCancelResponseDocumentInputType.FileID)]
    [InlineData(ClassifyCancelResponseDocumentInputType.ParseJobID)]
    [InlineData(ClassifyCancelResponseDocumentInputType.Url)]
    public void Validation_Works(ClassifyCancelResponseDocumentInputType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyCancelResponseDocumentInputType> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ClassifyCancelResponseDocumentInputType.ParseJobID)]
    [InlineData(ClassifyCancelResponseDocumentInputType.Url)]
    public void SerializationRoundtrip_Works(ClassifyCancelResponseDocumentInputType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyCancelResponseDocumentInputType> value = rawValue;
...
public class ClassifyCancelResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(ClassifyCancelResponseStatus.Cancelled)]
    [InlineData(ClassifyCancelResponseStatus.Completed)]
    [InlineData(ClassifyCancelResponseStatus.Failed)]
    [InlineData(ClassifyCancelResponseStatus.Pending)]
    [InlineData(ClassifyCancelResponseStatus.Running)]
    public void Validation_Works(ClassifyCancelResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyCancelResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    public void InvalidEnumValidationThrows_Works()
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, ClassifyCancelResponseStatus>>(
    ...
    [InlineData(ClassifyCancelResponseStatus.Pending)]
    [InlineData(ClassifyCancelResponseStatus.Running)]
    public void SerializationRoundtrip_Works(ClassifyCancelResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ClassifyCancelResponseStatus> value = rawValue;
        ...
        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, ClassifyCancelResponseStatus>
        >(json, ModelBase.SerializerOptions);
