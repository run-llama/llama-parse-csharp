...
public class PipelineUpdateParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        ...
        Pipelines::PipelineUpdateParamsEmbeddingConfig expectedEmbeddingConfig =
        ...
        Pipelines::PipelineUpdateParamsTransformConfig expectedTransformConfig =
    ...
    public void OptionalNullableParamsSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(parameters.LlamaParseParameters);
        Assert.True(parameters.RawBodyData.ContainsKey("llama_parse_parameters"));
        Assert.Null(parameters.ManagedPipelineID);
        ...
        Assert.Null(parameters.PresetRetrievalParameters);
        Assert.True(parameters.RawBodyData.ContainsKey("preset_retrieval_parameters"));
        Assert.Null(parameters.SparseModelConfig);
    ...
    public void CopyConstructor_Works()
    {
        ...
        Pipelines::PipelineUpdateParams copied = new(parameters);

        Assert.Equal(parameters, copied);
    }
}

public class PipelineUpdateParamsEmbeddingConfigTest : TestBase
{
    [Fact]
    public void AzureOpenAIValidationWorks()
    {
        Pipelines::PipelineUpdateParamsEmbeddingConfig value =
            new Pipelines::AzureOpenAIEmbeddingConfig()
            {
                Component = new()
                {
    ...
    public void AzureOpenAISerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<Pipelines::PipelineUpdateParamsEmbeddingConfig>(
                element,
...
public class PipelineUpdateParamsTransformConfigTest : TestBase
{
    [Fact]
    public void AutoValidationWorks()
    {
        Pipelines::PipelineUpdateParamsTransformConfig value = new Pipelines::AutoTransformConfig()
        {
            ChunkOverlap = 0,
            ChunkSize = 1,
            Mode = Pipelines::AutoTransformConfigMode.Auto,
    ...
    {
        Pipelines::PipelineUpdateParamsTransformConfig value =
            new Pipelines::AdvancedModeTransformConfig()
            {
                ChunkingConfig = new Pipelines::NoneChunkingConfig()
                {
                    Mode = Pipelines::Mode.None,
                },
    ...
    public void AutoSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Pipelines::PipelineUpdateParamsTransformConfig>(
                element,
                ModelBase.SerializerOptions
            );
