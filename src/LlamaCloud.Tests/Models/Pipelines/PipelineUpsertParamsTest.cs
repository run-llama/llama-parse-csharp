...
public class PipelineUpsertParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new Pipelines::PipelineUpsertParams
        {
            Name = "x",
        ...
        Pipelines::PipelineUpsertParamsEmbeddingConfig expectedEmbeddingConfig =
        ...
        Pipelines::PipelineUpsertParamsTransformConfig expectedTransformConfig =
    ...
    {
        Pipelines::PipelineUpsertParams parameters = new()
        {
            Name = "x",
            OrganizationID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ProjectID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    public void CopyConstructor_Works()
    {
        ...
        Pipelines::PipelineUpsertParams copied = new(parameters);

        Assert.Equal(parameters, copied);
    }
}

public class PipelineUpsertParamsEmbeddingConfigTest : TestBase
{
    [Fact]
    public void AzureOpenAIValidationWorks()
    {
        Pipelines::PipelineUpsertParamsEmbeddingConfig value =
            new Pipelines::AzureOpenAIEmbeddingConfig()
            {
                Component = new()
                {
    ...
    public void AzureOpenAISerializationRoundtripWorks()
    {
        ...
        var deserialized =
            JsonSerializer.Deserialize<Pipelines::PipelineUpsertParamsEmbeddingConfig>(
                element,
...
public class PipelineUpsertParamsTransformConfigTest : TestBase
{
    [Fact]
    public void AutoValidationWorks()
    {
        Pipelines::PipelineUpsertParamsTransformConfig value = new Pipelines::AutoTransformConfig()
        {
            ChunkOverlap = 0,
            ChunkSize = 1,
            Mode = Pipelines::AutoTransformConfigMode.Auto,
    ...
    {
        Pipelines::PipelineUpsertParamsTransformConfig value =
    ...
    public void AutoSerializationRoundtripWorks()
    {
        ...
        string element = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized =
            JsonSerializer.Deserialize<Pipelines::PipelineUpsertParamsTransformConfig>(
                element,
                ModelBase.SerializerOptions
            );
