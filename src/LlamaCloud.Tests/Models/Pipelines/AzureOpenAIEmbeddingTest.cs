...
public class AzureOpenAIEmbeddingTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AzureOpenAIEmbedding
        {
        ...
        string expectedAzureDeployment = "azure_deployment";
        string expectedAzureEndpoint = "azure_endpoint";
        ...
        Assert.Equal(expectedAzureDeployment, model.AzureDeployment);
        Assert.Equal(expectedAzureEndpoint, model.AzureEndpoint);
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AzureOpenAIEmbedding>(
            json,
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        Assert.Equal(expectedAzureDeployment, deserialized.AzureDeployment);
        Assert.Equal(expectedAzureEndpoint, deserialized.AzureEndpoint);
    ...
    public void OptionalNullablePropertiesUnsetAreNotSet_Works()
    {
        ...
        Assert.Null(model.AzureDeployment);
        Assert.False(model.RawData.ContainsKey("azure_deployment"));
        Assert.Null(model.AzureEndpoint);
        Assert.False(model.RawData.ContainsKey("azure_endpoint"));
    ...
    public void OptionalNullablePropertiesSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(model.AzureDeployment);
        Assert.True(model.RawData.ContainsKey("azure_deployment"));
        Assert.Null(model.AzureEndpoint);
        Assert.True(model.RawData.ContainsKey("azure_endpoint"));
        Assert.Null(model.DefaultHeaders);
    ...
    public void CopyConstructor_Works()
    {
        ...
        AzureOpenAIEmbedding copied = new(model);
