...
public class SheetCreateParamsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var parameters = new SheetCreateParams
        {
            ...
            Config = new()
            {
                ...
                TableMergeSensitivity = Sheets::TableMergeSensitivity.Strong,
                Tier = Sheets::Tier.Agentic,
        ...
        Sheets::SheetsParsingConfig expectedConfig = new()
        {
            ExtractionRange = "extraction_range",
            FlattenHierarchicalTables = true,
            GenerateAdditionalMetadata = true,
        ...
        Sheets::SheetsParsingConfig expectedConfiguration = new()
        {
            ExtractionRange = "extraction_range",
            FlattenHierarchicalTables = true,
            GenerateAdditionalMetadata = true,
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.cloud.llamaindex.ai/api/v1/sheets/jobs?organization_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&project_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
                ),
                url
            )
        );
