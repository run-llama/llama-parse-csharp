...
public class SheetListPageResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new SheetListPageResponse
        {
            ...
            [
                new()
                {
                    ...
                    Status = Sheets::SheetsJobStatus.Cancelled,
                    ...
                    Parameters = new()
                    {
                        ...
                        [
                            new()
                            {
                                WebhookEvents =
                                [
                                    Sheets::ParametersWebhookConfigurationWebhookEvent.ParseSuccess,
                                    Sheets::ParametersWebhookConfigurationWebhookEvent.ParseError,
                                ],
        ...
        List<Sheets::SheetsJob> expectedItems =
        [
            new()
            {
                ID = "id",
