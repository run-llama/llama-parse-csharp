...
public class ParsingCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ParsingCreateResponse
        {
            ID = "pjb-aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee",
            ProjectID = "prj-aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee",
            Status = ParsingCreateResponseStatus.Cancelled,
        ...
        ApiEnum<string, ParsingCreateResponseStatus> expectedStatus =
            ParsingCreateResponseStatus.Cancelled;
        DateTimeOffset expectedCreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z");
        string expectedErrorMessage = "error_message";
        string expectedName = "Q4 Financial Report";
        string expectedTier = "fast";
        DateTimeOffset expectedUpdatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z");
        Usage expectedUsage = new() { Credits = 30 };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ParsingCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ParsingCreateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ParsingCreateResponseStatusTest : TestBase
{
    [Theory]
    [InlineData(ParsingCreateResponseStatus.Cancelled)]
    [InlineData(ParsingCreateResponseStatus.Completed)]
    [InlineData(ParsingCreateResponseStatus.Failed)]
    [InlineData(ParsingCreateResponseStatus.Pending)]
    [InlineData(ParsingCreateResponseStatus.Running)]
    public void Validation_Works(ParsingCreateResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ParsingCreateResponseStatus> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, ParsingCreateResponseStatus>>(
    ...
    [InlineData(ParsingCreateResponseStatus.Pending)]
    [InlineData(ParsingCreateResponseStatus.Running)]
    public void SerializationRoundtrip_Works(ParsingCreateResponseStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ParsingCreateResponseStatus> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, ParsingCreateResponseStatus>>(
            json,
            ModelBase.SerializerOptions
        );
...
public class UsageTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Usage { Credits = 30 };
    ...
    public void OptionalNullablePropertiesSetToNullAreSetToNull_Works()
    {
        var model = new Usage { Credits = null };
