...
public class ConfigurationListPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ConfigurationListPageResponse
        {
            Items =
            [
                new()
                {
                    ...
                    ProductType = ConfigurationResponseProductType.ClassifyV2,
                    Version = "version",
        ...
        List<ConfigurationResponse> expectedItems =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ConfigurationListPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ConfigurationListPageResponse copied = new(model);
