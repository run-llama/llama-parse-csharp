...
public class ConfigurationDeleteParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new ConfigurationDeleteParams
        {
            ConfigID = "config_id",
    ...
    {
        var parameters = new ConfigurationDeleteParams { ConfigID = "config_id" };
    ...
    {
        ConfigurationDeleteParams parameters = new()
        {
            ConfigID = "config_id",
            OrganizationID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ProjectID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    public void CopyConstructor_Works()
    {
        ...
        ConfigurationDeleteParams copied = new(parameters);
