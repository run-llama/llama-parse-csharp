...
public class ClassifyV2ParametersTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ClassifyV2Parameters
        {
            Rules =
            [
                new()
        ...
        JsonElement expectedProductType = JsonSerializer.SerializeToElement("classify_v2");
    ...
    public void CopyConstructor_Works()
    {
        ...
        ClassifyV2Parameters copied = new(model);
