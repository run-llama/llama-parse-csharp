...
public class DataSinkListPaginatedParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new DataSinkListPaginatedParams
        {
            IncludeTotal = true,
    ...
    {
        var parameters = new DataSinkListPaginatedParams { IncludeTotal = true, PageSize = 1 };
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.cloud.llamaindex.ai/api/v1/beta/data-sinks?include_total=true&organization_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&page_size=1&page_token=page_token&project_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        DataSinkListPaginatedParams copied = new(parameters);
