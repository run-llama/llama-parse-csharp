...
public class BatchCancelParamsTest : TestBase
{
    ...
    {
        var parameters = new BatchCancelParams { BatchID = "batch_id" };
    ...
    {
        BatchCancelParams parameters = new()
        {
            BatchID = "batch_id",
            OrganizationID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ProjectID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.cloud.llamaindex.ai/api/v2/batches/batch_id/cancel?organization_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e&project_id=182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
                ),
                url
            )
        );
