...
public class SheetServiceTest : TestBase
{
    ...
    {
        var sheetsJob = await this.client.Sheets.Create(
    ...
    {
        var page = await this.client.Sheets.List(new(), TestContext.Current.CancellationToken);
        page.Validate();
    }
    ...
    {
        await this.client.Sheets.DeleteJob(
            "spreadsheet_job_id",
            new(),
            TestContext.Current.CancellationToken
        );
    ...
    {
        var sheetsJob = await this.client.Sheets.Get(
            "spreadsheet_job_id",
            new(),
            TestContext.Current.CancellationToken
        );
    ...
    {
        var presignedUrl = await this.client.Sheets.GetResultTable(
