...
namespace LlamaIndex.LlamaCloud.Tests;
...
public class RetriesTest : TestBase
{
    ...
    public async Task ImmediateSuccess_Works()
    {
        ...
        LlamaCloudClient client = new() { HttpClient = httpClient, MaxRetries = 2 };
    ...
    public async Task RetryAfterMsHeader_Works()
    {
        ...
        LlamaCloudClient client = new() { HttpClient = httpClient, MaxRetries = 1 };
