...
public class FileListResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new FileListResponse
        {
            ...
            FileID = "file_id",
            Metadata = new Dictionary<string, FileListResponseMetadata?>() { { "foo", "string" } },
        ...
        Files::PresignedUrl expectedDownloadUrl = new()
        {
            ExpiresAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Url = "https://example.com",
            FormFields = new Dictionary<string, string>() { { "foo", "string" } },
        ...
        Dictionary<string, FileListResponseMetadata?> expectedMetadata = new()
        {
            { "foo", "string" },
        };
...
public class FileListResponseMetadataTest : TestBase
{
    [Fact]
    public void StringValidationWorks()
    {
        FileListResponseMetadata value = "string";
        value.Validate();
    }
    ...
    {
        FileListResponseMetadata value = 0;
        value.Validate();
    }
    ...
    {
        FileListResponseMetadata value = true;
        value.Validate();
    }
    ...
    {
        FileListResponseMetadata value = new(["string"]);
        value.Validate();
    }
    ...
    public void StringSerializationRoundtripWorks()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FileListResponseMetadata>(
            element,
            ModelBase.SerializerOptions
        );
