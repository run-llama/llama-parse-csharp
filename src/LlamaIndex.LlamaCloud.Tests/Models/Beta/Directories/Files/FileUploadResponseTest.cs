...
public class FileUploadResponseTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new FileUploadResponse
        {
            ...
            FileID = "file_id",
            Metadata = new Dictionary<string, FileUploadResponseMetadata?>()
            {
                { "foo", "string" },
            },
        ...
        Dictionary<string, FileUploadResponseMetadata?> expectedMetadata = new()
        {
            { "foo", "string" },
        };
...
public class FileUploadResponseMetadataTest : TestBase
{
    [Fact]
    public void StringValidationWorks()
    {
        FileUploadResponseMetadata value = "string";
        value.Validate();
    }
    ...
    {
        FileUploadResponseMetadata value = 0;
        value.Validate();
    }
    ...
    {
        FileUploadResponseMetadata value = true;
        value.Validate();
    }
    ...
    {
        FileUploadResponseMetadata value = new(["string"]);
        value.Validate();
    }
    ...
    public void StringSerializationRoundtripWorks()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FileUploadResponseMetadata>(
            element,
            ModelBase.SerializerOptions
        );
