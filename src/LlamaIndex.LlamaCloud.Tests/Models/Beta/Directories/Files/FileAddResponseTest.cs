...
public class FileAddResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FileAddResponse
        {
            ID = "id",
            ...
            FileID = "file_id",
            Metadata = new Dictionary<string, FileAddResponseMetadata?>() { { "foo", "string" } },
        ...
        Dictionary<string, FileAddResponseMetadata?> expectedMetadata = new()
        {
            { "foo", "string" },
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FileAddResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        FileAddResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FileAddResponseMetadataTest : TestBase
{
    [Fact]
    public void StringValidationWorks()
    {
        FileAddResponseMetadata value = "string";
        value.Validate();
    }
    ...
    {
        FileAddResponseMetadata value = 0;
        value.Validate();
    }
    ...
    {
        FileAddResponseMetadata value = true;
        value.Validate();
    }
    ...
    {
        FileAddResponseMetadata value = new(["string"]);
        value.Validate();
    }
    ...
    public void StringSerializationRoundtripWorks()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FileAddResponseMetadata>(
            element,
            ModelBase.SerializerOptions
        );
