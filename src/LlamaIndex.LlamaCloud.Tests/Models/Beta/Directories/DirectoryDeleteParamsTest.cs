...
public class DirectoryDeleteParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new DirectoryDeleteParams
        {
    ...
    {
        var parameters = new DirectoryDeleteParams { DirectoryID = "directory_id" };
    ...
    {
        DirectoryDeleteParams parameters = new()
        {
            DirectoryID = "directory_id",
            OrganizationID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ProjectID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    public void CopyConstructor_Works()
    {
        ...
        DirectoryDeleteParams copied = new(parameters);
