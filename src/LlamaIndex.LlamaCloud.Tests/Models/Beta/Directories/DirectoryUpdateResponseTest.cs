...
public class DirectoryUpdateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DirectoryUpdateResponse
        {
            ID = "id",
            Name = "x",
            ...
            Type = DirectoryUpdateResponseType.Ephemeral,
        ...
        ApiEnum<string, DirectoryUpdateResponseType> expectedType =
            DirectoryUpdateResponseType.Ephemeral;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<DirectoryUpdateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        DirectoryUpdateResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class DirectoryUpdateResponseTypeTest : TestBase
{
    [Theory]
    [InlineData(DirectoryUpdateResponseType.Ephemeral)]
    [InlineData(DirectoryUpdateResponseType.Index)]
    [InlineData(DirectoryUpdateResponseType.User)]
    public void Validation_Works(DirectoryUpdateResponseType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DirectoryUpdateResponseType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, DirectoryUpdateResponseType>>(
    ...
    [InlineData(DirectoryUpdateResponseType.Index)]
    [InlineData(DirectoryUpdateResponseType.User)]
    public void SerializationRoundtrip_Works(DirectoryUpdateResponseType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, DirectoryUpdateResponseType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, DirectoryUpdateResponseType>>(
            json,
            ModelBase.SerializerOptions
        );
