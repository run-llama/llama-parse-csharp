...
public class DirectoryListPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DirectoryListPageResponse
        {
            Items =
            [
                new()
        ...
        List<DirectoryListResponse> expectedItems =
        [
            new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<DirectoryListPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        DirectoryListPageResponse copied = new(model);
