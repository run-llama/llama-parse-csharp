...
public class AgentDataDeleteParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new AgentDataDeleteParams
        {
            ItemID = "item_id",
    ...
    {
        var parameters = new AgentDataDeleteParams { ItemID = "item_id" };
    ...
    {
        AgentDataDeleteParams parameters = new()
        {
            ItemID = "item_id",
            OrganizationID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            ProjectID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
    ...
    public void CopyConstructor_Works()
    {
        ...
        AgentDataDeleteParams copied = new(parameters);
