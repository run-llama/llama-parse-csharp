...
public class IndexCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new IndexCreateResponse
        {
            ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<IndexCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        IndexCreateResponse copied = new(model);
