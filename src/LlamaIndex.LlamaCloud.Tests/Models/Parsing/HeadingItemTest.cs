...
public class HeadingItemTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new HeadingItem
        {
            Level = 0,
            Md = "md",
            Value = "value",
        ...
        ApiEnum<string, HeadingItemType> expectedType = HeadingItemType.Heading;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<HeadingItem>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        HeadingItem copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class HeadingItemTypeTest : TestBase
{
    [Theory]
    [InlineData(HeadingItemType.Heading)]
    public void Validation_Works(HeadingItemType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, HeadingItemType> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, HeadingItemType>>(
    ...
    [Theory]
    [InlineData(HeadingItemType.Heading)]
    public void SerializationRoundtrip_Works(HeadingItemType rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, HeadingItemType> value = rawValue;

        string json = JsonSerializer.Serialize(value, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ApiEnum<string, HeadingItemType>>(
            json,
            ModelBase.SerializerOptions
        );
