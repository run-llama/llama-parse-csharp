...
public class FileCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FileCreateResponse
        {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FileCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        FileCreateResponse copied = new(model);
