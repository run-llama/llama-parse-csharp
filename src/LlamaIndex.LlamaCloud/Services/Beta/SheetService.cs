...
public sealed class SheetService : ISheetService
{
    ...
    /// <inheritdoc/>
    [Obsolete("deprecated")]
    public async Task<SheetsJob> Create(
    ...
    /// <inheritdoc/>
    [Obsolete("deprecated")]
    public async Task<SheetsJob> Get(
...
public sealed class SheetServiceWithRawResponse : ISheetServiceWithRawResponse
{
    ...
    /// <inheritdoc/>
    [Obsolete("deprecated")]
    public async Task<HttpResponse<SheetsJob>> Create(
        SheetCreateParams parameters,
        CancellationToken cancellationToken = default
    )
    {
        ...
        return new(
            ...
            async (token) =>
            {
                var sheetsJob = await response.Deserialize<SheetsJob>(token).ConfigureAwait(false);
    ...
    /// <inheritdoc/>
    [Obsolete("deprecated")]
    public async Task<HttpResponse<SheetsJob>> Get(
        SheetGetParams parameters,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// <inheritdoc/>
    [Obsolete("deprecated")]
    public Task<HttpResponse<SheetsJob>> Get(
        string spreadsheetJobID,
        SheetGetParams? parameters = null,
        CancellationToken cancellationToken = default
    )
