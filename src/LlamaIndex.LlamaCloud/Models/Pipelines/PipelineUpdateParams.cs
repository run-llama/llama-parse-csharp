...
public record class PipelineUpdateParams : ParamsBase
{
    ...
    public PipelineUpdateParamsEmbeddingConfig? EmbeddingConfig
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<PipelineUpdateParamsEmbeddingConfig>(
                "embedding_config"
            );
        }
    ...
    public LlamaParseParameters? LlamaParseParameters
    {
        ...
        init { this._rawBodyData.Set("llama_parse_parameters", value); }
    }
    ...
    /// <summary>
    /// Schema for the search params for an retrieval execution that can be preset
    /// for a pipeline.
    /// </summary>
    public PresetRetrievalParams? PresetRetrievalParameters
    {
        ...
        init { this._rawBodyData.Set("preset_retrieval_parameters", value); }
    }
    ...
    /// </summary>
    public PipelineUpdateParamsTransformConfig? TransformConfig
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<PipelineUpdateParamsTransformConfig>(
                "transform_config"
            );
        }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PipelineUpdateParams(PipelineUpdateParams pipelineUpdateParams)
        : base(pipelineUpdateParams)
    {
        this.PipelineID = pipelineUpdateParams.PipelineID;

        this._rawBodyData = new(pipelineUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PipelineUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string pipelineID
    ...
    public virtual bool Equals(PipelineUpdateParams? other)
    {
        if (other == null)
        {
            return false;
...
[JsonConverter(typeof(PipelineUpdateParamsEmbeddingConfigConverter))]
public record class PipelineUpdateParamsEmbeddingConfig : ModelBase
{
    ...
    public PipelineUpdateParamsEmbeddingConfig(
    ...
    public PipelineUpdateParamsEmbeddingConfig(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of PipelineUpdateParamsEmbeddingConfig"
                );
        }
    }
    ...
    public static implicit operator PipelineUpdateParamsEmbeddingConfig(
        AzureOpenAIEmbeddingConfig value
    ) => new(value);
    ...
    public virtual bool Equals(PipelineUpdateParamsEmbeddingConfig? other) =>
        other != null
...
sealed class PipelineUpdateParamsEmbeddingConfigConverter
    : JsonConverter<PipelineUpdateParamsEmbeddingConfig?>
{
    public override PipelineUpdateParamsEmbeddingConfig? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new PipelineUpdateParamsEmbeddingConfig(element);
            }
        }
    }
    ...
    public override void Write(
        ...
        PipelineUpdateParamsEmbeddingConfig? value,
        JsonSerializerOptions options
    )
    {
...
/// Configuration for the transformation.
/// </summary>
[JsonConverter(typeof(PipelineUpdateParamsTransformConfigConverter))]
public record class PipelineUpdateParamsTransformConfig : ModelBase
{
    public object? Value { get; } = null;
    ...
    public PipelineUpdateParamsTransformConfig(
    ...
    public PipelineUpdateParamsTransformConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of PipelineUpdateParamsTransformConfig"
                );
        }
    }
    ...
    public static implicit operator PipelineUpdateParamsTransformConfig(
        AutoTransformConfig value
    ) => new(value);
    ...
    public virtual bool Equals(PipelineUpdateParamsTransformConfig? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class PipelineUpdateParamsTransformConfigConverter
    : JsonConverter<PipelineUpdateParamsTransformConfig?>
{
    public override PipelineUpdateParamsTransformConfig? Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        PipelineUpdateParamsTransformConfig? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
