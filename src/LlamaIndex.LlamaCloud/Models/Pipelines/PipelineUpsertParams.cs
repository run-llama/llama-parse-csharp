...
public record class PipelineUpsertParams : ParamsBase
{
    ...
    public PipelineUpsertParamsEmbeddingConfig? EmbeddingConfig
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<PipelineUpsertParamsEmbeddingConfig>(
                "embedding_config"
            );
        }
    ...
    /// </summary>
    public PipelineUpsertParamsTransformConfig? TransformConfig
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<PipelineUpsertParamsTransformConfig>(
                "transform_config"
            );
        }
    ...
    public PipelineUpsertParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PipelineUpsertParams(PipelineUpsertParams pipelineUpsertParams)
        : base(pipelineUpsertParams)
    {
        this._rawBodyData = new(pipelineUpsertParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PipelineUpsertParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(PipelineUpsertParams? other)
    {
        if (other == null)
        {
            return false;
...
[JsonConverter(typeof(PipelineUpsertParamsEmbeddingConfigConverter))]
public record class PipelineUpsertParamsEmbeddingConfig : ModelBase
{
    ...
    public PipelineUpsertParamsEmbeddingConfig(
    ...
    public PipelineUpsertParamsEmbeddingConfig(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of PipelineUpsertParamsEmbeddingConfig"
                );
        }
    }
    ...
    public static implicit operator PipelineUpsertParamsEmbeddingConfig(
        AzureOpenAIEmbeddingConfig value
    ) => new(value);
    ...
    public virtual bool Equals(PipelineUpsertParamsEmbeddingConfig? other) =>
        other != null
...
sealed class PipelineUpsertParamsEmbeddingConfigConverter
    : JsonConverter<PipelineUpsertParamsEmbeddingConfig?>
{
    public override PipelineUpsertParamsEmbeddingConfig? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new PipelineUpsertParamsEmbeddingConfig(element);
            }
        }
    }
    ...
    public override void Write(
        ...
        PipelineUpsertParamsEmbeddingConfig? value,
        JsonSerializerOptions options
    )
    {
...
/// Configuration for the transformation.
/// </summary>
[JsonConverter(typeof(PipelineUpsertParamsTransformConfigConverter))]
public record class PipelineUpsertParamsTransformConfig : ModelBase
{
    public object? Value { get; } = null;
    ...
    public PipelineUpsertParamsTransformConfig(
    ...
    public PipelineUpsertParamsTransformConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of PipelineUpsertParamsTransformConfig"
                );
        }
    }
    ...
    public static implicit operator PipelineUpsertParamsTransformConfig(
        AutoTransformConfig value
    ) => new(value);
    ...
    public virtual bool Equals(PipelineUpsertParamsTransformConfig? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class PipelineUpsertParamsTransformConfigConverter
    : JsonConverter<PipelineUpsertParamsTransformConfig?>
{
    public override PipelineUpsertParamsTransformConfig? Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        PipelineUpsertParamsTransformConfig? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
