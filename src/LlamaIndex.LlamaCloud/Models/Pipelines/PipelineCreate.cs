...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<PipelineCreate, PipelineCreateFromRaw>))]
public sealed record class PipelineCreate : JsonModel
{
    ...
    public DataSinkCreate? DataSink
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<DataSinkCreate>("data_sink");
        }
    ...
    public string? DataSinkID
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<string>("data_sink_id");
        }
        init { this._rawData.Set("data_sink_id", value); }
    }

    public PipelineCreateEmbeddingConfig? EmbeddingConfig
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<PipelineCreateEmbeddingConfig>(
                "embedding_config"
            );
        }
    ...
    public LlamaParseParameters? LlamaParseParameters
    {
        ...
        init
        {
            ...
            this._rawData.Set("llama_parse_parameters", value);
        }
    }
    ...
    /// </summary>
    public PipelineCreateTransformConfig? TransformConfig
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<PipelineCreateTransformConfig>(
                "transform_config"
            );
        }
        init { this._rawData.Set("transform_config", value); }
    }
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PipelineCreate(PipelineCreate pipelineCreate)
        : base(pipelineCreate) { }
#pragma warning restore CS8618

    public PipelineCreate(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    PipelineCreate(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="PipelineCreateFromRaw.FromRawUnchecked"/>
    public static PipelineCreate FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData)
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
    }

    [SetsRequiredMembers]
    public PipelineCreate(string name)
        : this()
    {
        this.Name = name;
    }
...
class PipelineCreateFromRaw : IFromRawJson<PipelineCreate>
{
    /// <inheritdoc/>
    public PipelineCreate FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        PipelineCreate.FromRawUnchecked(rawData);
}

[JsonConverter(typeof(PipelineCreateEmbeddingConfigConverter))]
public record class PipelineCreateEmbeddingConfig : ModelBase
{
    ...
    public PipelineCreateEmbeddingConfig(
    ...
    public PipelineCreateEmbeddingConfig(BedrockEmbeddingConfig value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public PipelineCreateEmbeddingConfig(CohereEmbeddingConfig value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public PipelineCreateEmbeddingConfig(GeminiEmbeddingConfig value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }
    ...
    public PipelineCreateEmbeddingConfig(OpenAIEmbeddingConfig value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public PipelineCreateEmbeddingConfig(VertexAIEmbeddingConfig value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public PipelineCreateEmbeddingConfig(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of PipelineCreateEmbeddingConfig"
                );
        }
    }
    ...
    public static implicit operator PipelineCreateEmbeddingConfig(
        AzureOpenAIEmbeddingConfig value
    ) => new(value);

    public static implicit operator PipelineCreateEmbeddingConfig(BedrockEmbeddingConfig value) =>
        new(value);

    public static implicit operator PipelineCreateEmbeddingConfig(CohereEmbeddingConfig value) =>
        new(value);

    public static implicit operator PipelineCreateEmbeddingConfig(GeminiEmbeddingConfig value) =>
        new(value);
    ...
    public static implicit operator PipelineCreateEmbeddingConfig(OpenAIEmbeddingConfig value) =>
        new(value);

    public static implicit operator PipelineCreateEmbeddingConfig(VertexAIEmbeddingConfig value) =>
        new(value);
    ...
    public virtual bool Equals(PipelineCreateEmbeddingConfig? other) =>
        other != null
...
sealed class PipelineCreateEmbeddingConfigConverter : JsonConverter<PipelineCreateEmbeddingConfig?>
{
    public override PipelineCreateEmbeddingConfig? Read(
    ...
    )
    {
        ...
        switch (type)
        {
            ...
            default:
            {
                return new PipelineCreateEmbeddingConfig(element);
            }
        }
    }
    ...
    public override void Write(
        ...
        PipelineCreateEmbeddingConfig? value,
        JsonSerializerOptions options
    )
    {
...
/// Configuration for the transformation.
/// </summary>
[JsonConverter(typeof(PipelineCreateTransformConfigConverter))]
public record class PipelineCreateTransformConfig : ModelBase
{
    public object? Value { get; } = null;
    ...
    public PipelineCreateTransformConfig(AutoTransformConfig value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public PipelineCreateTransformConfig(
    ...
    public PipelineCreateTransformConfig(JsonElement element)
    {
        this._element = element;
    }
    ...
    )
    {
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of PipelineCreateTransformConfig"
                );
        }
    }
    ...
    public static implicit operator PipelineCreateTransformConfig(AutoTransformConfig value) =>
        new(value);

    public static implicit operator PipelineCreateTransformConfig(
        AdvancedModeTransformConfig value
    ) => new(value);
    ...
    public virtual bool Equals(PipelineCreateTransformConfig? other) =>
        other != null
        && this.VariantIndex() == other.VariantIndex()
        && JsonElement.DeepEquals(this.Json, other.Json);
...
sealed class PipelineCreateTransformConfigConverter : JsonConverter<PipelineCreateTransformConfig?>
{
    public override PipelineCreateTransformConfig? Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    ...
    public override void Write(
        Utf8JsonWriter writer,
        PipelineCreateTransformConfig? value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(writer, value?.Json, options);
