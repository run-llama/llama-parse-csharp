...
public sealed record class CompositeRetrievalResult : JsonModel
{
    ...
    /// </summary>
    public IReadOnlyList<global::LlamaIndex.LlamaCloud.Models.Retrievers.Node>? Nodes
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableStruct<
                ImmutableArray<global::LlamaIndex.LlamaCloud.Models.Retrievers.Node>
            >("nodes");
        }
        init
        {
            ...
            this._rawData.Set<ImmutableArray<global::LlamaIndex.LlamaCloud.Models.Retrievers.Node>?>(
                "nodes",
                value == null ? null : ImmutableArray.ToImmutableArray(value)
            );
        }
...
[JsonConverter(
    typeof(JsonModelConverter<
        global::LlamaIndex.LlamaCloud.Models.Retrievers.Node,
        global::LlamaIndex.LlamaCloud.Models.Retrievers.NodeFromRaw
    >)
)]
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public Node(global::LlamaIndex.LlamaCloud.Models.Retrievers.Node node)
        : base(node) { }
#pragma warning restore CS8618
...
#pragma warning restore CS8618
    ...
    /// <inheritdoc cref="global::LlamaIndex.LlamaCloud.Models.Retrievers.NodeFromRaw.FromRawUnchecked"/>
    public static global::LlamaIndex.LlamaCloud.Models.Retrievers.Node FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    )
    {
        return new(FrozenDictionary.ToFrozenDictionary(rawData));
...
class NodeFromRaw : IFromRawJson<global::LlamaIndex.LlamaCloud.Models.Retrievers.Node>
{
    /// <inheritdoc/>
    public global::LlamaIndex.LlamaCloud.Models.Retrievers.Node FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => global::LlamaIndex.LlamaCloud.Models.Retrievers.Node.FromRawUnchecked(rawData);
}
