...
/// </summary>
public record class WebhookConfigListParams : ParamsBase
{
    ...
    public WebhookConfigListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WebhookConfigListParams(WebhookConfigListParams webhookConfigListParams)
        : base(webhookConfigListParams) { }
...
#pragma warning restore CS8618
    ...
    public static WebhookConfigListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(WebhookConfigListParams? other)
    {
        if (other == null)
        {
            return false;
