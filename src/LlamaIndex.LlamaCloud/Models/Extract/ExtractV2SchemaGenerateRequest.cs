...
[JsonConverter(
    typeof(JsonModelConverter<
        ...
        ExtractV2SchemaGenerateRequestFromRaw
    >)
)]
public sealed record class ExtractV2SchemaGenerateRequest : JsonModel
{
    /// <summary>
    /// Optional schema to validate, refine, or extend
    /// </summary>
    public IReadOnlyDictionary<string, ExtractV2SchemaGenerateRequestDataSchema?>? DataSchema
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                FrozenDictionary<string, ExtractV2SchemaGenerateRequestDataSchema?>
            >("data_schema");
        }
        init
        {
            this._rawData.Set<FrozenDictionary<string, ExtractV2SchemaGenerateRequestDataSchema?>?>(
                "data_schema",
...
#pragma warning disable CS8618
    ...
    public ExtractV2SchemaGenerateRequest(
        ...
        : base(extractV2SchemaGenerateRequest) { }
#pragma warning restore CS8618

    public ExtractV2SchemaGenerateRequest(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ExtractV2SchemaGenerateRequest(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ExtractV2SchemaGenerateRequestFromRaw.FromRawUnchecked"/>
    public static ExtractV2SchemaGenerateRequest FromRawUnchecked(
...
class ExtractV2SchemaGenerateRequestFromRaw : IFromRawJson<ExtractV2SchemaGenerateRequest>
{
    /// <inheritdoc/>
    public ExtractV2SchemaGenerateRequest FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ExtractV2SchemaGenerateRequest.FromRawUnchecked(rawData);
}

[JsonConverter(typeof(ExtractV2SchemaGenerateRequestDataSchemaConverter))]
public record class ExtractV2SchemaGenerateRequestDataSchema : ModelBase
{
    ...
    public ExtractV2SchemaGenerateRequestDataSchema(
    ...
    public ExtractV2SchemaGenerateRequestDataSchema(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ExtractV2SchemaGenerateRequestDataSchema(double value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ExtractV2SchemaGenerateRequestDataSchema(bool value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public ExtractV2SchemaGenerateRequestDataSchema(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of ExtractV2SchemaGenerateRequestDataSchema"
                );
        }
    }
    ...
    public static implicit operator ExtractV2SchemaGenerateRequestDataSchema(
    ...
    public static implicit operator ExtractV2SchemaGenerateRequestDataSchema(string value) =>
        new(value);

    public static implicit operator ExtractV2SchemaGenerateRequestDataSchema(double value) =>
        new(value);

    public static implicit operator ExtractV2SchemaGenerateRequestDataSchema(bool value) =>
        new(value);
    ...
    public virtual bool Equals(ExtractV2SchemaGenerateRequestDataSchema? other) =>
        other != null
...
sealed class ExtractV2SchemaGenerateRequestDataSchemaConverter
    : JsonConverter<ExtractV2SchemaGenerateRequestDataSchema?>
{
    public override ExtractV2SchemaGenerateRequestDataSchema? Read(
    ...
    public override void Write(
        ...
        ExtractV2SchemaGenerateRequestDataSchema? value,
        JsonSerializerOptions options
    )
    {
