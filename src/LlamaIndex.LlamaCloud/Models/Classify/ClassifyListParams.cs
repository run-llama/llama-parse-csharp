...
/// </summary>
public record class ClassifyListParams : ParamsBase
{
    /// <summary>
    ...
    public ClassifyListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ClassifyListParams(ClassifyListParams classifyListParams)
        : base(classifyListParams) { }
...
#pragma warning restore CS8618
    ...
    public static ClassifyListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ClassifyListParams? other)
    {
        if (other == null)
        {
            return false;
