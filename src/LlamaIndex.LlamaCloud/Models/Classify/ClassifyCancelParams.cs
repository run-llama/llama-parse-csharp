...
/// </summary>
public record class ClassifyCancelParams : ParamsBase
{
    ...
    public ClassifyCancelParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ClassifyCancelParams(ClassifyCancelParams classifyCancelParams)
        : base(classifyCancelParams)
    {
        this.JobID = classifyCancelParams.JobID;
    }
...
#pragma warning restore CS8618
    ...
    public static ClassifyCancelParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string jobID
    )
    ...
    public virtual bool Equals(ClassifyCancelParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v2/classify/{0}/cancel", this.JobID)
        )
        {
