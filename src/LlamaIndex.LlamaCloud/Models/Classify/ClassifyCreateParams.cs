...
/// ID (`dfl-...`) or parse job ID (`pjb-...`), and provide either inline `configuration`
/// with rules or a `configuration_id` referencing a saved preset.</para>
///
/// <para>Each rule has a `type` (the label to assign) and a `description` (natural
/// language criteria). The classifier returns the best matching rule with a confidence score.</para>
///
...
/// </summary>
public record class ClassifyCreateParams : ParamsBase
{
    ...
    public ClassifyConfiguration? Configuration
    {
        get
        {
            ...
            return this._rawBodyData.GetNullableClass<ClassifyConfiguration>("configuration");
        }
    ...
    public string? FileInput
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<string>("file_input");
        }
    ...
    public string? ParseJobID
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<string>("parse_job_id");
        }
        init { this._rawBodyData.Set("parse_job_id", value); }
    }
    ...
    public ClassifyCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ClassifyCreateParams(ClassifyCreateParams classifyCreateParams)
        : base(classifyCreateParams)
    {
        this._rawBodyData = new(classifyCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static ClassifyCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(ClassifyCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v2/classify")
        {
