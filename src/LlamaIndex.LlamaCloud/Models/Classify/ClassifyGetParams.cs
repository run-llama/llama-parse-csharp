...
/// </summary>
public record class ClassifyGetParams : ParamsBase
{
    ...
    public ClassifyGetParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ClassifyGetParams(ClassifyGetParams classifyGetParams)
        : base(classifyGetParams)
    {
        this.JobID = classifyGetParams.JobID;
    }
...
#pragma warning restore CS8618
    ...
    public static ClassifyGetParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string jobID
    )
    ...
    public virtual bool Equals(ClassifyGetParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/api/v2/classify/{0}", this.JobID)
        )
        {
