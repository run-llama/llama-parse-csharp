...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<ClassifyConfiguration, ClassifyConfigurationFromRaw>))]
public sealed record class ClassifyConfiguration : JsonModel
{
    /// <summary>
    ...
    public ClassifyConfiguration() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ClassifyConfiguration(ClassifyConfiguration classifyConfiguration)
        : base(classifyConfiguration) { }
#pragma warning restore CS8618

    public ClassifyConfiguration(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ClassifyConfiguration(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ClassifyConfigurationFromRaw.FromRawUnchecked"/>
    public static ClassifyConfiguration FromRawUnchecked(
    ...
    [SetsRequiredMembers]
    public ClassifyConfiguration(IReadOnlyList<Rule> rules)
        : this()
    {
        this.Rules = rules;
    }
...
class ClassifyConfigurationFromRaw : IFromRawJson<ClassifyConfiguration>
{
    /// <inheritdoc/>
    public ClassifyConfiguration FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => ClassifyConfiguration.FromRawUnchecked(rawData);
}
