...
public sealed record class Job : JsonModel
{
    ...
    /// </summary>
    public required ApiEnum<string, global::LlamaIndex.LlamaCloud.Models.Batches.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::LlamaIndex.LlamaCloud.Models.Batches.Type>
            >("type");
        }
...
sealed class TypeConverter : JsonConverter<global::LlamaIndex.LlamaCloud.Models.Batches.Type>
{
    public override global::LlamaIndex.LlamaCloud.Models.Batches.Type Read(
    ...
    )
    {
        ...
        {
            "parse_v2" => global::LlamaIndex.LlamaCloud.Models.Batches.Type.ParseV2,
            "extract_v2" => global::LlamaIndex.LlamaCloud.Models.Batches.Type.ExtractV2,
            _ => (global::LlamaIndex.LlamaCloud.Models.Batches.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::LlamaIndex.LlamaCloud.Models.Batches.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::LlamaIndex.LlamaCloud.Models.Batches.Type.ParseV2 => "parse_v2",
                global::LlamaIndex.LlamaCloud.Models.Batches.Type.ExtractV2 => "extract_v2",
