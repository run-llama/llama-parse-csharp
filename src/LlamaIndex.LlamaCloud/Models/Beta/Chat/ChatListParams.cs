...
/// </summary>
public record class ChatListParams : ParamsBase
{
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ChatListParams(ChatListParams chatListParams)
        : base(chatListParams) { }
...
#pragma warning restore CS8618
    ...
    public static ChatListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ChatListParams? other)
    {
        if (other == null)
        {
            return false;
