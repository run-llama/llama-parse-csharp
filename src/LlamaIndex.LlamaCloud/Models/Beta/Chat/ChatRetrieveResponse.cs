...
public sealed record class Stop : JsonModel
{
    ...
    public ApiEnum<string, global::LlamaIndex.LlamaCloud.Models.Beta.Chat.Type>? Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                ApiEnum<string, global::LlamaIndex.LlamaCloud.Models.Beta.Chat.Type>
            >("type");
        }
        init
        {
...
sealed class TypeConverter : JsonConverter<global::LlamaIndex.LlamaCloud.Models.Beta.Chat.Type>
{
    public override global::LlamaIndex.LlamaCloud.Models.Beta.Chat.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        ...
        {
            "stop" => global::LlamaIndex.LlamaCloud.Models.Beta.Chat.Type.Stop,
            _ => (global::LlamaIndex.LlamaCloud.Models.Beta.Chat.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::LlamaIndex.LlamaCloud.Models.Beta.Chat.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::LlamaIndex.LlamaCloud.Models.Beta.Chat.Type.Stop => "stop",
                _ => throw new LlamaCloudInvalidDataException(
