...
/// move the file to a different directory. To resolve from `unique_id`, list with
/// a filter first.
///
...
public record class FileUpdateParams : ParamsBase
{
    ...
    public string? TargetDirectoryID
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<string>("target_directory_id");
        }
        init { this._rawBodyData.Set("target_directory_id", value); }
    }
...
#pragma warning disable CS8618
    ...
    {
        this.DirectoryID = fileUpdateParams.DirectoryID;
        this.DirectoryFileID = fileUpdateParams.DirectoryFileID;
