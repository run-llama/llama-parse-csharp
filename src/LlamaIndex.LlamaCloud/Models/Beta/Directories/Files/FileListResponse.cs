...
using Files = LlamaIndex.LlamaCloud.Models.Files;
using System = System;
...
public sealed record class FileListResponse : JsonModel
{
    ...
    /// </summary>
    public Files::PresignedUrl? DownloadUrl
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<Files::PresignedUrl>("download_url");
        }
    ...
    /// </summary>
    public IReadOnlyDictionary<string, FileListResponseMetadata?>? Metadata
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<
                FrozenDictionary<string, FileListResponseMetadata?>
            >("metadata");
        }
        init
        {
            ...
            this._rawData.Set<FrozenDictionary<string, FileListResponseMetadata?>?>(
                "metadata",
...
[JsonConverter(typeof(FileListResponseMetadataConverter))]
public record class FileListResponseMetadata : ModelBase
{
    ...
    public FileListResponseMetadata(string value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileListResponseMetadata(long value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileListResponseMetadata(double value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileListResponseMetadata(bool value, JsonElement? element = null)
    {
        this.Value = value;
        this._element = element;
    }

    public FileListResponseMetadata(IReadOnlyList<string> value, JsonElement? element = null)
    {
        this.Value = ImmutableArray.ToImmutableArray(value);
        this._element = element;
    }

    public FileListResponseMetadata(JsonElement element)
    {
        this._element = element;
    }
        ...
        switch (this.Value)
        {
            ...
            default:
                throw new LlamaCloudInvalidDataException(
                    "Data did not match any variant of FileListResponseMetadata"
                );
        }
    }
    ...
    public static implicit operator FileListResponseMetadata(string value) => new(value);

    public static implicit operator FileListResponseMetadata(long value) => new(value);

    public static implicit operator FileListResponseMetadata(double value) => new(value);

    public static implicit operator FileListResponseMetadata(bool value) => new(value);

    public static implicit operator FileListResponseMetadata(List<string> value) =>
    ...
    public virtual bool Equals(FileListResponseMetadata? other) =>
        other != null
...
sealed class FileListResponseMetadataConverter : JsonConverter<FileListResponseMetadata>
{
    public override FileListResponseMetadata? Read(
    ...
    public override void Write(
        ...
        FileListResponseMetadata value,
        JsonSerializerOptions options
    )
    {
