...
public record class SheetCreateParams : ParamsBase
{
    ...
    public SheetsParsingConfig? Config
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<SheetsParsingConfig>("config");
        }
    ...
    /// Configuration for spreadsheet parsing and region extraction
    /// </summary>
    public SheetsParsingConfig? Configuration
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<SheetsParsingConfig>("configuration");
        }
