...
/// </summary>
[Obsolete("deprecated")]
public record class SheetListParams : ParamsBase
{
    /// <summary>
    ...
    public SheetListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SheetListParams(SheetListParams sheetListParams)
        : base(sheetListParams) { }
...
#pragma warning restore CS8618
    ...
    public static SheetListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(SheetListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/beta/sheets/jobs")
        {
