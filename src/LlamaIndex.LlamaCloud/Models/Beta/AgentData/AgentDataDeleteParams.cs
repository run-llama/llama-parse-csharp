...
/// </summary>
public record class AgentDataDeleteParams : ParamsBase
{
    ...
    public AgentDataDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AgentDataDeleteParams(AgentDataDeleteParams agentDataDeleteParams)
        : base(agentDataDeleteParams)
    {
        this.ItemID = agentDataDeleteParams.ItemID;
    }
...
#pragma warning restore CS8618
    ...
    public static AgentDataDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string itemID
    )
    ...
    public virtual bool Equals(AgentDataDeleteParams? other)
    {
        if (other == null)
        {
            return false;
