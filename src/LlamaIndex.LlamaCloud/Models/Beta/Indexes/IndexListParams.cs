...
/// </summary>
public record class IndexListParams : ParamsBase
{
    ...
    public IndexListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IndexListParams(IndexListParams indexListParams)
        : base(indexListParams) { }
...
#pragma warning restore CS8618
    ...
    public static IndexListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(IndexListParams? other)
    {
        if (other == null)
        {
            return false;
