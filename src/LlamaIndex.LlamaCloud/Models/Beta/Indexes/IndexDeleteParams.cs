...
/// </summary>
public record class IndexDeleteParams : ParamsBase
{
    ...
    public IndexDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IndexDeleteParams(IndexDeleteParams indexDeleteParams)
        : base(indexDeleteParams)
    {
        this.IndexID = indexDeleteParams.IndexID;
    }
...
#pragma warning restore CS8618
    ...
    public static IndexDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string indexID
    )
    ...
    public virtual bool Equals(IndexDeleteParams? other)
    {
        if (other == null)
        {
            return false;
