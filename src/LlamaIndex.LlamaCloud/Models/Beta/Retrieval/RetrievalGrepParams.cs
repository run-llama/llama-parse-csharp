...
/// </summary>
public record class RetrievalGrepParams : ParamsBase
{
    ...
    public required string Pattern
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNotNullClass<string>("pattern");
        }
        init { this._rawBodyData.Set("pattern", value); }
    }
    ...
    public long? ContextChars
    {
        ...
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableStruct<long>("context_chars");
        }
        init { this._rawBodyData.Set("context_chars", value); }
    }
    ...
    public RetrievalGrepParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RetrievalGrepParams(RetrievalGrepParams retrievalGrepParams)
        : base(retrievalGrepParams)
    {
        this._rawBodyData = new(retrievalGrepParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static RetrievalGrepParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(RetrievalGrepParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/retrieval/files/grep"
        )
        {
