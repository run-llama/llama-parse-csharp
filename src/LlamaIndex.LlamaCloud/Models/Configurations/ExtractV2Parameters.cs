...
/// </summary>
[JsonConverter(typeof(JsonModelConverter<ExtractV2Parameters, ExtractV2ParametersFromRaw>))]
public sealed record class ExtractV2Parameters : JsonModel
{
    /// <summary>
    ...
    public ApiEnum<string, ExtractV2ParametersTier>? Tier
    {
        ...
        {
            this._rawData.Freeze();
            return this._rawData.GetNullableClass<ApiEnum<string, ExtractV2ParametersTier>>("tier");
        }
        init
        {
            if (value == null)
    ...
    public override void Validate()
    {
        ...
        if (
            !JsonElement.DeepEquals(
                this.ProductType,
                JsonSerializer.SerializeToElement("extract_v2")
            )
        )
        {
    ...
    {
        this.ProductType = JsonSerializer.SerializeToElement("extract_v2");
    }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExtractV2Parameters(ExtractV2Parameters extractV2Parameters)
        : base(extractV2Parameters) { }
#pragma warning restore CS8618

    public ExtractV2Parameters(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    ExtractV2Parameters(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="ExtractV2ParametersFromRaw.FromRawUnchecked"/>
    public static ExtractV2Parameters FromRawUnchecked(
    ...
    [SetsRequiredMembers]
    public ExtractV2Parameters(IReadOnlyDictionary<string, DataSchema?> dataSchema)
        : this()
    {
...
class ExtractV2ParametersFromRaw : IFromRawJson<ExtractV2Parameters>
{
    /// <inheritdoc/>
    public ExtractV2Parameters FromRawUnchecked(IReadOnlyDictionary<string, JsonElement> rawData) =>
        ExtractV2Parameters.FromRawUnchecked(rawData);
}
...
{
    public override ExtractV2ParametersTier Read(
        ref Utf8JsonReader reader,
        Type typeToConvert,
        JsonSerializerOptions options
    )
