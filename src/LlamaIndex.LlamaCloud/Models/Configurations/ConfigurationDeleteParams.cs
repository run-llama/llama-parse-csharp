...
/// </summary>
public record class ConfigurationDeleteParams : ParamsBase
{
    ...
    public ConfigurationDeleteParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ConfigurationDeleteParams(ConfigurationDeleteParams configurationDeleteParams)
        : base(configurationDeleteParams)
    {
        this.ConfigID = configurationDeleteParams.ConfigID;
    }
...
#pragma warning restore CS8618
    ...
    public static ConfigurationDeleteParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string configID
    )
    ...
    public virtual bool Equals(ConfigurationDeleteParams? other)
    {
        if (other == null)
        {
            return false;
