...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ProjectListParams(ProjectListParams projectListParams)
...
#pragma warning restore CS8618
    ...
    public static ProjectListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(ProjectListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/api/v1/projects")
        {
