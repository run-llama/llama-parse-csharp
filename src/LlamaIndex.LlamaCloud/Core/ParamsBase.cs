...
public abstract record class ParamsBase
{
    ...
    static ParamsBase()
    {
        ...
        var customHeadersEnv = Environment.GetEnvironmentVariable("LLAMA_CLOUD_CUSTOM_HEADERS");
    ...
    static string GetUserAgent() => $"{typeof(LlamaCloudClient).Name}/C# {GetPackageVersion()}";
